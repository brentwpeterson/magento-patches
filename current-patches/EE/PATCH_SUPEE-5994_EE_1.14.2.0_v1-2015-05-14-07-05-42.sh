...
SUPEE-5994 | EE_1.14.2.0 | v1 | 1b90ba6bf6566afcdc15fd1815fc96d6ecc322d5 | Thu May 14 15:28:54 2015 +0300 | v1.14.2.0..HEAD
...
index a9b4896..7e39a53 100644
--- app/code/core/Mage/ImportExport/Model/Export/Adapter/Csv.php
+++ app/code/core/Mage/ImportExport/Model/Export/Adapter/Csv.php
@@ -107,9 +107,21 @@ class Mage_ImportExport_Model_Export_Adapter_Csv extends Mage_ImportExport_Model
...
index b642822..9cef908 100644
--- get.php
+++ get.php
@@ -35,7 +35,7 @@ $start = microtime(true);
 /**
  * Error reporting
  */
...
index 1acb0f8..606bcbb 100644
--- lib/Varien/Io/File.php
+++ lib/Varien/Io/File.php
@@ -232,6 +232,17 @@ class Varien_Io_File extends Varien_Io_Abstract
