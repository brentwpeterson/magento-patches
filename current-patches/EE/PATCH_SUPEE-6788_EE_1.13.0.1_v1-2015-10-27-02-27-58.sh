...
SUPEE-6788 | EE_1.13.0.1 | v1 | 6e9dc5b5788332e49a25578d2c4315eb422316e2 | Tue Oct 27 12:28:33 2015 +0200 | 09722fd924b26eaa8072e11c3c4497b1301a1813..6e9dc5b5788332e49a25578d2c4315eb422316e2
...
@@ -290,17 +300,16 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
@@ -734,21 +754,37 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
     /**
...
+
             ...
             $this->_getSession()->addError($this->_getHelper('customer')->__('Your password reset link has expired.'));
             $this->_redirect('*/*/forgotpassword');
@@ -761,10 +797,9 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
      */
