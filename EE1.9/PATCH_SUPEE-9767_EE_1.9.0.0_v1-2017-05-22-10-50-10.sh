...
PATCH_SUPEE-9767_EE_1.9.0.0_v1.sh | EE_1.9.0.0 | v1 | 226caf7 | Mon Feb 20 17:33:39 2017 +0200 | 2321b14

__PATCHFILE_FOLLOWS__
diff --git app/Mage.php app/Mage.php
index 5bdc05d..dd8a5b9 100644
--- app/Mage.php
+++ app/Mage.php
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -93,8 +116,14 @@ class Enterprise_PageCache_Model_Observer
         }
         /**
...
@@ -105,13 +134,15 @@ class Enterprise_PageCache_Model_Observer
     /**
...
@@ -119,12 +150,14 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -146,6 +179,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -167,6 +201,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -174,13 +209,15 @@ class Enterprise_PageCache_Model_Observer
             return $this;
         }
         $object = $observer->getEvent()->getObject();
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -188,11 +225,14 @@ class Enterprise_PageCache_Model_Observer
             return $this;
         }
         $object = $observer->getEvent()->getObject();
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -202,6 +242,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -213,6 +254,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -222,6 +264,7 @@ class Enterprise_PageCache_Model_Observer
...
@@ -235,6 +278,7 @@ class Enterprise_PageCache_Model_Observer
      *
      * @param Varien_Event_Observer $observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -253,6 +297,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -276,6 +321,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -321,6 +367,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -332,18 +379,12 @@ class Enterprise_PageCache_Model_Observer
     }
...
-        // update customer viewed products index
         try {
             ...
             if ($productIds) {
@@ -364,16 +405,32 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -381,6 +438,14 @@ class Enterprise_PageCache_Model_Observer
             return $this;
         }
         $this->_getCookie()->updateCustomerCookies();
+
...
@@ -388,6 +453,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -414,6 +480,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -433,6 +500,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -444,6 +512,20 @@ class Enterprise_PageCache_Model_Observer
     }
...
@@ -453,8 +535,6 @@ class Enterprise_PageCache_Model_Observer
...
@@ -491,8 +571,19 @@ class Enterprise_PageCache_Model_Observer
...
index be5bcf7..83faa94 100644
--- app/code/core/Mage/Checkout/controllers/OnepageController.php
+++ app/code/core/Mage/Checkout/controllers/OnepageController.php
@@ -303,6 +303,11 @@ class Mage_Checkout_OnepageController extends Mage_Checkout_Controller_Action
         if ($this->_expireAjax()) {
             return;
         }
+
...
@@ -318,6 +323,11 @@ class Mage_Checkout_OnepageController extends Mage_Checkout_Controller_Action
         if ($this->_expireAjax()) {
             return;
         }
+
...
@@ -363,6 +373,11 @@ class Mage_Checkout_OnepageController extends Mage_Checkout_Controller_Action
         if ($this->_expireAjax()) {
             return;
         }
+
...
@@ -387,6 +402,11 @@ class Mage_Checkout_OnepageController extends Mage_Checkout_Controller_Action
         if ($this->_expireAjax()) {
             return;
         }
+
...
@@ -417,6 +437,11 @@ class Mage_Checkout_OnepageController extends Mage_Checkout_Controller_Action
         if ($this->_expireAjax()) {
             return;
         }
+
...
+     * @return null
     ...
     {
@@ -480,12 +486,32 @@ abstract class Mage_Core_Controller_Varien_Action
...
@@ -494,6 +520,8 @@ abstract class Mage_Core_Controller_Varien_Action
             return;
         }
...
@@ -540,7 +568,6 @@ abstract class Mage_Core_Controller_Varien_Action
             $this->renderLayout();
         } else {
...
@@ -602,23 +629,45 @@ abstract class Mage_Core_Controller_Varien_Action
             ->setDispatched(false);
     }
...
+    /**
      ...
      *
      * @param   string $url
@@ -636,8 +685,30 @@ abstract class Mage_Core_Controller_Varien_Action
      * @param   string $path
...
index 015f66faf..fbdd054 100644
--- app/code/core/Mage/Core/Controller/Varien/Front.php
+++ app/code/core/Mage/Core/Controller/Varien/Front.php
@@ -296,7 +296,17 @@ class Mage_Core_Controller_Varien_Front extends Varien_Object
...
@@ -306,22 +316,58 @@ class Mage_Core_Controller_Varien_Front extends Varien_Object
             return;
         }
...
index 42c2fe6..5d5ec3c 100644
--- app/code/core/Mage/Core/Controller/Varien/Router/Standard.php
+++ app/code/core/Mage/Core/Controller/Varien/Router/Standard.php
@@ -429,7 +429,7 @@ class Mage_Core_Controller_Varien_Router_Standard extends Mage_Core_Controller_V
...
index 233dec6..a71696d 100644
--- app/code/core/Mage/Core/Model/Session/Abstract/Varien.php
+++ app/code/core/Mage/Core/Model/Session/Abstract/Varien.php
@@ -406,4 +406,15 @@ class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
...
@@ -218,7 +254,7 @@ class Mage_Customer_Model_Session extends Mage_Core_Model_Session_Abstract
     {
         if ($this->isLoggedIn()) {
...
@@ -227,18 +263,93 @@ class Mage_Customer_Model_Session extends Mage_Core_Model_Session_Abstract
...
@@ -42,6 +41,13 @@ Supported layout update handles (special):
 <layout>
...
@@ -111,10 +117,10 @@ Default layout, loads most of the pages
...
@@ -128,7 +134,7 @@ Default layout, loads most of the pages
...
@@ -137,12 +137,17 @@ class Maged_Connect
     /**
...
@@ -216,13 +221,13 @@ class Maged_Connect
     }
...
+     */
     ...
     {
         @set_time_limit(0);
@@ -256,7 +261,13 @@ class Maged_Connect
         }
     }
...
@@ -266,10 +277,33 @@ class Maged_Connect
     }
...
-
 ...
 {
     /**
@@ -90,11 +89,18 @@ final class Maged_Controller
     private $_view;
...
+    private $_localConfig;
     ...
     /**
      * Session instance
@@ -136,43 +142,68 @@ final class Maged_Controller
...
@@ -183,7 +214,6 @@ final class Maged_Controller
...
-     *
     ...
     {
@@ -193,7 +223,6 @@ final class Maged_Controller
...
-     *
     ...
     {
@@ -203,7 +232,6 @@ final class Maged_Controller
...
-     *
     ...
     public function logoutAction()
     {
@@ -213,48 +241,61 @@ final class Maged_Controller
...
@@ -278,34 +319,69 @@ final class Maged_Controller
             $chan = 'community';
         }
...
-     *
     ...
     {
@@ -337,7 +413,6 @@ final class Maged_Controller
...
-     *
     ...
     {
@@ -363,7 +438,7 @@ final class Maged_Controller
             return;
         }
...
@@ -375,8 +450,16 @@ final class Maged_Controller
     }
...
-     *
     ...
     {
@@ -395,25 +478,23 @@ final class Maged_Controller
         }
         /* //EE_CHANNEL */
...
-     *
     ...
     {
@@ -421,15 +502,34 @@ final class Maged_Controller
...
@@ -438,7 +538,6 @@ final class Maged_Controller
...
-     *
     ...
     {
@@ -448,7 +547,6 @@ final class Maged_Controller
...
-     *
     ...
     {
@@ -471,7 +569,7 @@ final class Maged_Controller
             self::$_instance = new self;
...
@@ -579,17 +677,31 @@ final class Maged_Controller
     /**
...
@@ -658,10 +770,10 @@ final class Maged_Controller
     {
...
@@ -689,7 +801,7 @@ final class Maged_Controller
      */
...
@@ -712,7 +824,6 @@ final class Maged_Controller
...
-     *
     ...
     {
@@ -721,7 +832,7 @@ final class Maged_Controller
         $this->setAction();
...
@@ -749,7 +860,6 @@ final class Maged_Controller
...
@@ -813,21 +923,20 @@ final class Maged_Controller
...
@@ -835,33 +944,63 @@ final class Maged_Controller
...
@@ -104,35 +117,58 @@ class Maged_Model_Session extends Maged_Model
         }
...
+     */
     ...
     {
         if (!$this->_session) {
@@ -143,36 +179,40 @@ class Maged_Model_Session extends Maged_Model
     }
...
@@ -184,10 +224,10 @@ class Maged_Model_Session extends Maged_Model
     }
...
@@ -208,4 +248,24 @@ class Maged_Model_Session extends Maged_Model
         }
...
index c1fd22d..4013c65 100644
--- skin/frontend/enterprise/default/js/opcheckout.js
+++ skin/frontend/enterprise/default/js/opcheckout.js
@@ -637,7 +637,7 @@ Payment.prototype = {
         var elements = Form.getElements(this.form);
         var method = null;
         for (var i=0; i<elements.length; i++) {
-            if (elements[i].name=='payment[method]') {
