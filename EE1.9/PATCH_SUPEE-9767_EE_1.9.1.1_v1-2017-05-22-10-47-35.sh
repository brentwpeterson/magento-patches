...
PATCH_SUPEE-9767_EE_1.9.1.1_v1.sh | EE_1.9.1.1 | v1 | 226caf7 | Mon Feb 20 17:33:39 2017 +0200 | 2321b14

__PATCHFILE_FOLLOWS__
diff --git app/Mage.php app/Mage.php
index eb25869..924819c 100644
--- app/Mage.php
+++ app/Mage.php
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -443,6 +511,20 @@ class Enterprise_PageCache_Model_Observer
     }
...
@@ -452,8 +534,6 @@ class Enterprise_PageCache_Model_Observer
...
@@ -490,8 +570,19 @@ class Enterprise_PageCache_Model_Observer
...
@@ -607,23 +634,45 @@ abstract class Mage_Core_Controller_Varien_Action
             ->setDispatched(false);
     }
...
+    /**
      ...
      *
      * @param   string $url
@@ -641,8 +690,30 @@ abstract class Mage_Core_Controller_Varien_Action
      * @param   string $path
...
index 59f8334..520fe86 100644
--- app/code/core/Mage/Sales/Model/Quote/Item.php
+++ app/code/core/Mage/Sales/Model/Quote/Item.php
@@ -386,8 +386,9 @@ class Mage_Sales_Model_Quote_Item extends Mage_Sales_Model_Quote_Item_Abstract
...
index afc1207..14755c3 100644
--- app/design/adminhtml/default/default/layout/main.xml
+++ app/design/adminhtml/default/default/layout/main.xml
@@ -118,7 +118,7 @@ Default layout, loads most of the pages
...
@@ -143,40 +142,63 @@ final class Maged_Controller
...
-     *
     ...
     {
@@ -186,7 +208,6 @@ final class Maged_Controller
...
-     *
     ...
     {
@@ -196,7 +217,6 @@ final class Maged_Controller
...
-     *
     ...
     public function logoutAction()
     {
@@ -206,50 +226,49 @@ final class Maged_Controller
...
+        $this->getFtpPost($p);
         ...
         /* todo show errors */
         if ($errors) {
@@ -270,14 +289,13 @@ final class Maged_Controller
...
-     *
     ...
     {
@@ -288,23 +306,31 @@ final class Maged_Controller
         }
...
-     * 
     ...
     {
@@ -312,24 +338,20 @@ final class Maged_Controller
...
-     *
     ...
     {
@@ -337,14 +359,11 @@ final class Maged_Controller
             echo "INVALID POST DATA";
             return;
         }
-        $this->channelConfig()->setSettingsSession($this->config(),$this->session());
...
-     *
     ...
     {
@@ -370,7 +389,7 @@ final class Maged_Controller
             return;
         }
...
@@ -382,8 +401,16 @@ final class Maged_Controller
     }
...
-     *
     ...
     {
@@ -395,32 +422,36 @@ final class Maged_Controller
         $this->view()->set('mkdir_mode', decoct($config->__get('global_dir_mode')));
         $this->view()->set('chmod_file_mode', decoct($config->__get('global_file_mode')));
...
@@ -430,17 +461,18 @@ final class Maged_Controller
                 return;
             }
             try {
...
@@ -450,7 +482,6 @@ final class Maged_Controller
...
-     *
     ...
     {
@@ -460,7 +491,6 @@ final class Maged_Controller
...
-     *
     ...
     {
@@ -483,7 +513,7 @@ final class Maged_Controller
...
@@ -684,10 +714,10 @@ final class Maged_Controller
     {
...
@@ -715,7 +745,7 @@ final class Maged_Controller
      */
...
@@ -738,7 +768,6 @@ final class Maged_Controller
...
-     *
     ...
     {
@@ -747,7 +776,7 @@ final class Maged_Controller
         $this->setAction();
...
@@ -758,7 +787,6 @@ final class Maged_Controller
...
@@ -776,7 +804,6 @@ final class Maged_Controller
...
@@ -840,21 +867,20 @@ final class Maged_Controller
...
@@ -862,38 +888,102 @@ final class Maged_Controller
