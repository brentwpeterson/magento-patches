...
SUPEE-10266-1.9.0.0 | EE_1.9.0.0 | v1 | a1fdc1c1842a27219294891ffa38927b8971d700 | Tue Sep 5 13:22:06 2017 +0300 | 2ee4a175613a3766d6ae4806dbc3c2112abaacd1..HEAD
...
+                }
             ...
             return $this;
@@ -434,4 +444,27 @@ class Mage_Adminhtml_Controller_Action extends Mage_Core_Controller_Varien_Actio
         }
         return true;
     }
+
...
index 26ff0df..b04692f 100644
--- app/code/core/Mage/Checkout/controllers/CartController.php
+++ app/code/core/Mage/Checkout/controllers/CartController.php
@@ -236,15 +236,17 @@ class Mage_Checkout_CartController extends Mage_Core_Controller_Front_Action
...
-        /* @var $itemsCollection Mage_Sales_Model_Mysql4_Order_Item_Collection */
         ...
         foreach ($itemsCollection as $item) {
             try {
@@ -419,4 +421,14 @@ class Mage_Checkout_CartController extends Mage_Core_Controller_Front_Action
...
+    <?php echo $this->__('Latest Message:') ?></strong> <?php echo $this->escapeHtml($this->getLatestNotice()); ?> <a href="<?php echo $this->getLatestNoticeUrl() ?>" onclick="this.target='_blank';"><?php echo $this->__('Read details') ?></a>
 </div>
 <?php endif; ?>
...
index 6fc008f..ab7ee39 100644
--- app/design/adminhtml/default/default/template/sales/order/view/info.phtml
+++ app/design/adminhtml/default/default/template/sales/order/view/info.phtml
@@ -129,7 +129,7 @@ $orderStoreDate = $this->formatDate($_order->getCreatedAtStoreDate(), 'medium',
                 <?php if ($_groupName = $this->getCustomerGroupName()) : ?>
                 <tr>
                     <td class="label"><label><?php echo Mage::helper('sales')->__('Customer Group') ?></label></td>
-                    <td><strong><?php echo $_groupName ?></strong></td>
+                    <td><strong><?php echo $this->escapeHtml($_groupName) ?></strong></td>
                 </tr>
                 <?php endif; ?>
