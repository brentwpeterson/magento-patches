...
SUPEE-6788 | EE_1.9.0.0 | v2 | 09ff536ed5334b464c368a93fc1fc6e4c1305485 | Wed Nov 25 12:31:46 2015 +0200 | 9a75157b25f17e537985be20467c108c3289a9d6..09ff536ed5334b464c368a93fc1fc6e4c1305485
...
diff --git app/code/core/Mage/Bundle/Block/Adminhtml/Catalog/Product/Edit/Tab/Bundle.php app/code/core/Mage/Bundle/Block/Adminhtml/Catalog/Product/Edit/Tab/Bundle.php
index 6ed6465..b4fafcc 100644
...
diff --git app/code/core/Mage/Bundle/Block/Adminhtml/Catalog/Product/Edit/Tab/Bundle/Option/Search/Grid.php app/code/core/Mage/Bundle/Block/Adminhtml/Catalog/Product/Edit/Tab/Bundle/Option/Search/Grid.php
index 9277dc1..87867b1 100644
...
diff --git app/code/core/Mage/Bundle/Block/Adminhtml/Catalog/Product/Edit/Tab/Bundle/Option/Selection.php app/code/core/Mage/Bundle/Block/Adminhtml/Catalog/Product/Edit/Tab/Bundle/Option/Selection.php
index 0675364..b2579a8 100644
--- app/code/core/Mage/Bundle/Block/Adminhtml/Catalog/Product/Edit/Tab/Bundle/Option/Selection.php
+++ app/code/core/Mage/Bundle/Block/Adminhtml/Catalog/Product/Edit/Tab/Bundle/Option/Selection.php
@@ -95,6 +95,6 @@ class Mage_Bundle_Block_Adminhtml_Catalog_Product_Edit_Tab_Bundle_Option_Selecti
...
diff --git app/code/core/Mage/Bundle/Model/Mysql4/Option/Collection.php app/code/core/Mage/Bundle/Model/Mysql4/Option/Collection.php
index d37c3af..df27fc0 100644
--- app/code/core/Mage/Bundle/Model/Mysql4/Option/Collection.php
+++ app/code/core/Mage/Bundle/Model/Mysql4/Option/Collection.php
@@ -58,7 +58,7 @@ class Mage_Bundle_Model_Mysql4_Option_Collection extends Mage_Core_Model_Mysql4_
...
@@ -119,9 +119,9 @@ class Mage_Bundle_Model_Mysql4_Option_Collection extends Mage_Core_Model_Mysql4_
...
diff --git app/code/core/Mage/Bundle/controllers/Adminhtml/Bundle/Product/EditController.php app/code/core/Mage/Bundle/controllers/Adminhtml/Bundle/Product/EditController.php
new file mode 100644
index 0000000..3472a7e
--- /dev/null
...
+
+}
diff --git app/code/core/Mage/Bundle/controllers/Product/EditController.php app/code/core/Mage/Bundle/controllers/Product/EditController.php
index 2f711b0..c67ff22 100644
...
diff --git app/code/core/Mage/Bundle/controllers/SelectionController.php app/code/core/Mage/Bundle/controllers/SelectionController.php
index 4988c2e..9d3e79f 100644
...
diff --git app/code/core/Mage/Bundle/etc/config.xml app/code/core/Mage/Bundle/etc/config.xml
index 5a2ed63..a76ad3f 100644
...
+                    <modules>
+                        <Mage_Bundle after="Mage_Adminhtml">Mage_Bundle_Adminhtml</Mage_Bundle>
+                    </modules>
                 </args>
-            </bundle>
+            </adminhtml>
...
diff --git app/code/core/Mage/Compiler/Block/Process.php app/code/core/Mage/Compiler/Block/Process.php
index e7f640a..6c9b21b 100644
...
+                        'onclick' => 'setLocation(\'' . $this->getUrl('adminhtml/compiler_process/disable') . '\')',
                         'class'     => 'save'
             )));
         } else {
...
+                        'onclick' => 'setLocation(\'' . $this->getUrl('adminhtml/compiler_process/enable') . '\')',
                         'class'     => 'save'
             )));
         }
...
+        return $this->getUrl('adminhtml/compiler_process/recompile');
     }
 
     /**
diff --git app/code/core/Mage/Compiler/controllers/Adminhtml/Compiler/ProcessController.php app/code/core/Mage/Compiler/controllers/Adminhtml/Compiler/ProcessController.php
new file mode 100644
index 0000000..a8aea4b
--- /dev/null
...
+    }
+}
diff --git app/code/core/Mage/Compiler/controllers/ProcessController.php app/code/core/Mage/Compiler/controllers/ProcessController.php
index b1f707a..0764432 100644
...
diff --git app/code/core/Mage/Compiler/etc/adminhtml.xml app/code/core/Mage/Compiler/etc/adminhtml.xml
index 447ff91..37f8807 100644
...
diff --git app/code/core/Mage/Compiler/etc/config.xml app/code/core/Mage/Compiler/etc/config.xml
index 8707c36..dd435bc 100644
...
+                    <modules>
+                        <Mage_Compiler after="Mage_Adminhtml">Mage_Compiler_Adminhtml</Mage_Compiler>
+                    </modules>
                 </args>
-            </compiler>
+            </adminhtml>
...
diff --git app/code/core/Mage/Customer/Model/Entity/Attribute/Collection.php app/code/core/Mage/Customer/Model/Entity/Attribute/Collection.php
index 2820f9e..c3d5b09 100644
--- app/code/core/Mage/Customer/Model/Entity/Attribute/Collection.php
+++ app/code/core/Mage/Customer/Model/Entity/Attribute/Collection.php
@@ -195,7 +195,8 @@ class Mage_Customer_Model_Entity_Attribute_Collection extends Mage_Eav_Model_Mys
...
index 3ebe792..89ff25d 100644
--- app/code/core/Mage/Downloadable/Block/Adminhtml/Catalog/Product/Edit/Tab/Downloadable/Links.php
+++ app/code/core/Mage/Downloadable/Block/Adminhtml/Catalog/Product/Edit/Tab/Downloadable/Links.php
@@ -171,7 +171,7 @@ class Mage_Downloadable_Block_Adminhtml_Catalog_Product_Edit_Tab_Downloadable_Li
...
+                $name = '<a href="' . $this->getUrl('adminhtml/downloadable_product_edit/link', array('id' => $item->getId(), '_secure' => true)) . '">' .
...
diff --git app/code/core/Mage/Downloadable/controllers/Adminhtml/Downloadable/FileController.php app/code/core/Mage/Downloadable/controllers/Adminhtml/Downloadable/FileController.php
new file mode 100644
index 0000000..8f2f531
--- /dev/null
+++ app/code/core/Mage/Downloadable/controllers/Adminhtml/Downloadable/FileController.php
@@ -0,0 +1,81 @@
+<?php
+/**
+ * Magento Enterprise Edition
...
+
+}
diff --git app/code/core/Mage/Downloadable/controllers/Adminhtml/Downloadable/Product/EditController.php app/code/core/Mage/Downloadable/controllers/Adminhtml/Downloadable/Product/EditController.php
new file mode 100644
index 0000000..1a512e8
--- /dev/null
...
+
+}
diff --git app/code/core/Mage/Downloadable/controllers/FileController.php app/code/core/Mage/Downloadable/controllers/FileController.php
index d32394d..92bf7de 100644
--- app/code/core/Mage/Downloadable/controllers/FileController.php
+++ app/code/core/Mage/Downloadable/controllers/FileController.php
@@ -30,52 +30,16 @@
  * @category    Mage
  * @package     Mage_Downloadable
...
+class Mage_Downloadable_FileController extends Mage_Core_Controller_Front_Action
 {
-
-    /**
-     * Upload file controller action
...
diff --git app/code/core/Mage/Downloadable/controllers/Product/EditController.php app/code/core/Mage/Downloadable/controllers/Product/EditController.php
index 576893c..609b755 100644
--- app/code/core/Mage/Downloadable/controllers/Product/EditController.php
+++ app/code/core/Mage/Downloadable/controllers/Product/EditController.php
@@ -24,106 +24,22 @@
  * @license     http://www.magentocommerce.com/license/enterprise-edition
  */
...
+class Mage_Downloadable_Product_EditController extends Mage_Core_Controller_Front_Action
 {
-
-    /**
-     * Varien class constructor
...
-                    <frontName>downloadableadmin</frontName>
+                    <modules>
+                        <Mage_Downloadable after="Mage_Adminhtml">Mage_Downloadable_Adminhtml</Mage_Downloadable>
+                    </modules>
                 </args>
-            </downloadableadmin>
+            </adminhtml>
     ...
     <default>
diff --git app/code/core/Mage/GoogleBase/Block/Adminhtml/Items/Product.php app/code/core/Mage/GoogleBase/Block/Adminhtml/Items/Product.php
index 4c86044..4f7f9ed 100644
--- app/code/core/Mage/GoogleBase/Block/Adminhtml/Items/Product.php
+++ app/code/core/Mage/GoogleBase/Block/Adminhtml/Items/Product.php
...
+        return $this->getUrl('adminhtml/googlebase_selection/grid', array('index' => $this->getIndex(),'_current'=>true));
     }
 
     protected function _getGoogleBaseProductIds()
diff --git app/code/core/Mage/GoogleBase/controllers/Adminhtml/Googlebase/ItemsController.php app/code/core/Mage/GoogleBase/controllers/Adminhtml/Googlebase/ItemsController.php
new file mode 100644
index 0000000..8e03f5f
--- /dev/null
...
+    }
+}
diff --git app/code/core/Mage/GoogleBase/controllers/Adminhtml/Googlebase/SelectionController.php app/code/core/Mage/GoogleBase/controllers/Adminhtml/Googlebase/SelectionController.php
new file mode 100644
index 0000000..b54bc6b
--- /dev/null
+++ app/code/core/Mage/GoogleBase/controllers/Adminhtml/Googlebase/SelectionController.php
@@ -0,0 +1,57 @@
+<?php
+/**
+ * Magento Enterprise Edition
...
+    }
+}
diff --git app/code/core/Mage/GoogleBase/controllers/Adminhtml/Googlebase/TypesController.php app/code/core/Mage/GoogleBase/controllers/Adminhtml/Googlebase/TypesController.php
new file mode 100644
index 0000000..4220f5f
--- /dev/null
+++ app/code/core/Mage/GoogleBase/controllers/Adminhtml/Googlebase/TypesController.php
@@ -0,0 +1,265 @@
+<?php
+/**
+ * Magento Enterprise Edition
...
+    }
+}
diff --git app/code/core/Mage/GoogleBase/controllers/ItemsController.php app/code/core/Mage/GoogleBase/controllers/ItemsController.php
index 2c839e6..b8c345f 100644
--- app/code/core/Mage/GoogleBase/controllers/ItemsController.php
+++ app/code/core/Mage/GoogleBase/controllers/ItemsController.php
@@ -31,363 +31,8 @@
  * @package    Mage_GoogleBase
  * @name       Mage_GoogleBase_ItemTypesController
...
diff --git app/code/core/Mage/GoogleBase/controllers/SelectionController.php app/code/core/Mage/GoogleBase/controllers/SelectionController.php
index 8549a53..a9b8cb4 100644
...
diff --git app/code/core/Mage/GoogleBase/controllers/TypesController.php app/code/core/Mage/GoogleBase/controllers/TypesController.php
index 5daca16..b3c81be 100644
...
diff --git app/code/core/Mage/GoogleBase/etc/adminhtml.xml app/code/core/Mage/GoogleBase/etc/adminhtml.xml
index be92511..5b83041 100644
--- app/code/core/Mage/GoogleBase/etc/adminhtml.xml
+++ app/code/core/Mage/GoogleBase/etc/adminhtml.xml
@@ -34,11 +34,11 @@
                     <children>
...
diff --git app/code/core/Mage/GoogleBase/etc/config.xml app/code/core/Mage/GoogleBase/etc/config.xml
index bd33af9..b297129 100644
--- app/code/core/Mage/GoogleBase/etc/config.xml
+++ app/code/core/Mage/GoogleBase/etc/config.xml
@@ -70,13 +70,13 @@
     </global>
     <admin>
...
+                    <modules>
+                        <Mage_GoogleBase after="Mage_Adminhtml">Mage_GoogleBase_Adminhtml</Mage_GoogleBase>
+                    </modules>
                 </args>
-            </googlebase>
+            </adminhtml>
     ...
     <adminhtml>
diff --git app/code/core/Mage/GoogleOptimizer/Block/Js.php app/code/core/Mage/GoogleOptimizer/Block/Js.php
index ce66ed0..1d67da5 100644
--- app/code/core/Mage/GoogleOptimizer/Block/Js.php
+++ app/code/core/Mage/GoogleOptimizer/Block/Js.php
...
+        return $this->getUrl('adminhtml/googleoptimizer/codes');
     }
 
     public function getControlFieldKey ()
diff --git app/code/core/Mage/GoogleOptimizer/controllers/Adminhtml/GoogleoptimizerController.php app/code/core/Mage/GoogleOptimizer/controllers/Adminhtml/GoogleoptimizerController.php
new file mode 100644
index 0000000..99484f5
--- /dev/null
+++ app/code/core/Mage/GoogleOptimizer/controllers/Adminhtml/GoogleoptimizerController.php
@@ -0,0 +1,57 @@
+<?php
+/**
+ * Magento Enterprise Edition
...
+ * @author     Magento Core Team <core@magentocommerce.com>
+*/
+class Mage_GoogleOptimizer_Adminhtml_GoogleoptimizerController extends Mage_Adminhtml_Controller_Action
+{
+    /**
...
+    }
+}
diff --git app/code/core/Mage/GoogleOptimizer/controllers/IndexController.php app/code/core/Mage/GoogleOptimizer/controllers/IndexController.php
index 94577b4..c2e3abf 100644
--- app/code/core/Mage/GoogleOptimizer/controllers/IndexController.php
+++ app/code/core/Mage/GoogleOptimizer/controllers/IndexController.php
@@ -31,27 +31,8 @@
  * @package    Mage_GoogleOptimizer
  * @name       Mage_GoogleOptimizer_IndexController
...
+class Mage_GoogleOptimizer_IndexController extends Mage_GoogleOptimizer_Adminhtml_GoogleoptimizerController
 {
-    /**
-     * Retrieve js scripts by parsing remote Google Optimizer page
-     */
...
diff --git app/code/core/Mage/GoogleOptimizer/etc/config.xml app/code/core/Mage/GoogleOptimizer/etc/config.xml
index 61ab49f..72be532 100644
--- app/code/core/Mage/GoogleOptimizer/etc/config.xml
+++ app/code/core/Mage/GoogleOptimizer/etc/config.xml
@@ -81,13 +81,13 @@
             <image/>
         </attributes>
...
+                    <modules>
+                        <Mage_GoogleOptimizer after="Mage_Adminhtml">Mage_GoogleOptimizer_Adminhtml</Mage_GoogleOptimizer>
+                    </modules>
                 </args>
-            </googleoptimizer>
+            </adminhtml>
...
+
     ...
     <adminhtml_permissions_role_index>
         <reference name="content">
diff --git app/design/adminhtml/default/default/layout/compiler.xml app/design/adminhtml/default/default/layout/compiler.xml
index 2d992f5..0f386b7 100644
...
index e7c6ebf..92ace60 100644
--- lib/Varien/Data/Collection/Db.php
+++ lib/Varien/Data/Collection/Db.php
@@ -349,8 +349,14 @@ class Varien_Data_Collection_Db extends Varien_Data_Collection
      */
...
@@ -398,7 +404,7 @@ class Varien_Data_Collection_Db extends Varien_Data_Collection
