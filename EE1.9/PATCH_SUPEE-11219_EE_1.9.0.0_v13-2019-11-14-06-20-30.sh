...
SUPEE-11219_EE_1900 | EE_1.9.0.0 | v1 | bdb73307ceaf7d694dd1757fe898a3f819de767f | Wed Nov 13 15:49:47 2019 +0000 | 0d12ffac51c86ede1a1b83f20e55c07b47800d72..HEAD
...
index 531d1ee35fd..250b21726c0 100644
...
index c7893e49c93..84a7bdca903 100644
--- app/code/core/Enterprise/Reminder/controllers/Adminhtml/ReminderController.php
+++ app/code/core/Enterprise/Reminder/controllers/Adminhtml/ReminderController.php
@@ -252,6 +252,17 @@ class Enterprise_Reminder_Adminhtml_ReminderController extends Mage_Adminhtml_Co
         }
     }
...
index f69daf223fd..d22319fcd11 100644
...
@@ -315,7 +335,7 @@ class Mage_Admin_Model_User extends Mage_Core_Model_Abstract
...
+        return Mage::helper('core')->getHashPassword($pwd, self::HASH_SALT_LENGTH);
     ...
     /**
@@ -414,15 +434,23 @@ class Mage_Admin_Model_User extends Mage_Core_Model_Abstract
         }
...
@@ -442,4 +470,15 @@ class Mage_Admin_Model_User extends Mage_Core_Model_Abstract
         return (array)$errors;
     }
...
index 20fd50354e1..d5fac108539 100644
...
index aceaebf8d1c..0ef05fe62b0 100644
...
@@ -125,9 +132,11 @@ class Mage_Adminhtml_Block_Customer_Edit_Tab_Account extends Mage_Adminhtml_Bloc
...
index 572bfe50671..b417487cb34 100644
...
index c8eb314e973..56db511286a 100644
--- app/code/core/Mage/Adminhtml/Block/Sales/Order/View.php
+++ app/code/core/Mage/Adminhtml/Block/Sales/Order/View.php
@@ -214,7 +214,7 @@ class Mage_Adminhtml_Block_Sales_Order_View extends Mage_Adminhtml_Block_Widget_
...
index dfe96c909dc..fa3bf48c80d 100644
--- app/code/core/Mage/Adminhtml/Block/Widget/Grid.php
+++ app/code/core/Mage/Adminhtml/Block/Widget/Grid.php
@@ -430,7 +430,7 @@ class Mage_Adminhtml_Block_Widget_Grid extends Mage_Adminhtml_Block_Widget
     {
...
index 79979b29429..a56ca1d7ffb 100644
--- app/code/core/Mage/Adminhtml/Model/LayoutUpdate/Validator.php
+++ app/code/core/Mage/Adminhtml/Model/LayoutUpdate/Validator.php
@@ -52,21 +52,26 @@ class Mage_Adminhtml_Model_LayoutUpdate_Validator extends Zend_Validate_Abstract
      *
      * @var array
      */
...
+    protected $_validator = null;
     ...
     /**
      * Construct
@@ -74,26 +79,17 @@ class Mage_Adminhtml_Model_LayoutUpdate_Validator extends Zend_Validate_Abstract
...
+        return $this->_validator->getMessages();
     ...
     /**
@@ -110,39 +106,42 @@ class Mage_Adminhtml_Model_LayoutUpdate_Validator extends Zend_Validate_Abstract
      */
...
+        return $this;
     ...
     /**
@@ -150,8 +149,19 @@ class Mage_Adminhtml_Model_LayoutUpdate_Validator extends Zend_Validate_Abstract
      *
...
+        return $this->_validator->getXpathBlockValidationExpression();
     ...
     /**
@@ -162,10 +172,6 @@ class Mage_Adminhtml_Model_LayoutUpdate_Validator extends Zend_Validate_Abstract
      */
...
index ae7e6ca87ee..5934bd8ec23 100644
...
@@ -253,7 +254,7 @@ class Mage_Adminhtml_Catalog_Product_AttributeController extends Mage_Adminhtml_
...
index 3fc6173abcf..9e8564976db 100644
--- app/code/core/Mage/Adminhtml/controllers/CustomerController.php
+++ app/code/core/Mage/Adminhtml/controllers/CustomerController.php
@@ -324,9 +324,15 @@ class Mage_Adminhtml_CustomerController extends Mage_Adminhtml_Controller_Action
                 }
...
index 642aa00254a..3388b820ded 100644
--- app/code/core/Mage/Adminhtml/controllers/Newsletter/TemplateController.php
+++ app/code/core/Mage/Adminhtml/controllers/Newsletter/TemplateController.php
@@ -254,4 +254,15 @@ class Mage_Adminhtml_Newsletter_TemplateController extends Mage_Adminhtml_Contro
...
index 0492e69febf..0625a85a9d7 100644
--- app/code/core/Mage/Adminhtml/controllers/Sales/OrderController.php
+++ app/code/core/Mage/Adminhtml/controllers/Sales/OrderController.php
@@ -689,4 +689,15 @@ class Mage_Adminhtml_Sales_OrderController extends Mage_Adminhtml_Controller_Act
...
index 0a600c87957..83401f4336b 100644
...
index 7c77e5754f0..f2a5103fd48 100644
...
@@ -493,6 +479,36 @@ abstract class Mage_Catalog_Block_Product_Abstract extends Mage_Core_Block_Templ
...
+
      ...
      *
@@ -512,4 +528,64 @@ abstract class Mage_Catalog_Block_Product_Abstract extends Mage_Core_Block_Templ
...
index d401158f471..641a11111af 100644
...
index 41031fd06d1..e6371e5ed37 100644
...
@@ -28,7 +28,7 @@
 <config>
     <modules>
         <Mage_Catalog>
-            <version>1.4.0.0.33</version>
+            <version>1.4.0.0.33.1.2</version>
         </Mage_Catalog>
     </modules>
 
diff --git app/code/core/Mage/Catalog/sql/catalog_setup/mysql4-upgrade-1.4.0.0.33.1.1-1.4.0.0.33.1.2.php app/code/core/Mage/Catalog/sql/catalog_setup/mysql4-upgrade-1.4.0.0.33.1.1-1.4.0.0.33.1.2.php
new file mode 100644
index 00000000000..e035621e802
--- /dev/null
+++ app/code/core/Mage/Catalog/sql/catalog_setup/mysql4-upgrade-1.4.0.0.33.1.1-1.4.0.0.33.1.2.php
@@ -0,0 +1,28 @@
+<?php
+/**
+ * Magento Enterprise Edition
...
index f896cbe300e..228c530fa4c 100644
--- app/code/core/Mage/Checkout/Block/Cart/Item/Renderer.php
+++ app/code/core/Mage/Checkout/Block/Cart/Item/Renderer.php
@@ -212,14 +212,26 @@ class Mage_Checkout_Block_Cart_Item_Renderer extends Mage_Core_Block_Template
      */
     public function getDeleteUrl()
     {
-        return $this->getUrl(
...
index 28b0c118c20..48b857f9b9d 100644
...
index 1a1909adef5..bcdf37b3b82 100644
...
index 88161154256..0f3563da934 100644
...
index 5467b052a6d..840e59776a6 100644
...
index 43999381a30..a62732e6bef 100644
--- app/code/core/Mage/Customer/Model/Customer.php
+++ app/code/core/Mage/Customer/Model/Customer.php
@@ -47,8 +47,14 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
...
@@ -334,7 +340,7 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
      */
...
+        return Mage::helper('core')->getHashPassword(trim($password), (bool) $salt ? $salt : Mage_Admin_Model_User::HASH_SALT_LENGTH);
     ...
     /**
@@ -345,6 +351,10 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
      */
...
@@ -742,12 +752,10 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
...
+                ->__('The minimum password length is %s', $minPasswordLength);
         ...
         if (
             strlen($password)
@@ -1158,4 +1166,16 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
         }
         return $entityTypeId;
     }
+
...
index 09a2211be8b..f204f011674 100644
--- app/code/core/Mage/Customer/Model/Customer/Attribute/Backend/Password.php
+++ app/code/core/Mage/Customer/Model/Customer/Attribute/Backend/Password.php
@@ -37,8 +37,12 @@ class Mage_Customer_Model_Customer_Attribute_Backend_Password extends Mage_Eav_M
     {
...
index 2a40bd8b37a..83825d4639f 100644
--- app/code/core/Mage/Customer/controllers/AccountController.php
+++ app/code/core/Mage/Customer/controllers/AccountController.php
@@ -771,14 +771,7 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
index 12710c175ce..8ca8589be86 100644
...
index 577697fc6b3..53774faa787 100644
...
@@ -146,6 +213,9 @@ class Mage_Dataflow_Model_Profile extends Mage_Core_Model_Abstract
...
index 85cdb5c49d6..197052aecce 100644
--- app/code/core/Mage/Review/controllers/ProductController.php
+++ app/code/core/Mage/Review/controllers/ProductController.php
@@ -293,7 +293,17 @@ class Mage_Review_ProductController extends Mage_Core_Controller_Front_Action
...
index 8d1e3fda0f9..7ef450a25db 100644
...
index e85a2b1e6df..df4593996cf 100644
...
index 52114bd202e..316509299d6 100644
...
index d7c3bffe945..c993b5371f5 100644
...
index 19ed940457f..44c0ede7283 100644
...
index 6c14ae03fb3..54820c44b04 100644
--- skin/adminhtml/default/default/boxes.css
+++ skin/adminhtml/default/default/boxes.css
@@ -1331,6 +1331,7 @@ ul.super-product-attributes { padding-left:15px; }
...
index 473befd873d..8ed76588c2a 100644
--- skin/adminhtml/default/enterprise/boxes.css
+++ skin/adminhtml/default/enterprise/boxes.css
@@ -1409,6 +1409,7 @@ ul.super-product-attributes { padding-left:15px; }
 .wrap               { white-space:normal !important; }
 .no-float           { float:none !important; }
 .pointer            { cursor:pointer; }
+.half               { width:50%; }
