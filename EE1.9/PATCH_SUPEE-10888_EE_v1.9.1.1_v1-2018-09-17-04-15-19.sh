...
SUPEE-10888_EE_v1.9.1.1 | CE_1.4.2.0 | v1 | 8fbb1df128084ea19b41f281c4cceecc01e5d42b | Tue Sep 11 10:51:59 2018 +0300 | ee-1.9.1.1-dev

__PATCHFILE_FOLLOWS__
diff --git app/code/core/Enterprise/GiftRegistry/Helper/Data.php app/code/core/Enterprise/GiftRegistry/Helper/Data.php
index a0383cfc0e5..28c79e59013 100644
...
index 46aa95e4173..1b1797155d5 100644
...
+
      ...
      */
@@ -442,4 +446,45 @@ class Mage_Admin_Model_User extends Mage_Core_Model_Abstract
         return (array)$errors;
     }
...
+
+        $templateId = Mage::getStoreConfig(self::XML_PATH_NOTIFICATION_EMAILS_TEMPLATE);
+        $sender = array('name'  => $generalContactName, 'email' => $generalContactEmail);
+        $email = array_filter($emails);
+        $name = $generalContactName;
+        $vars = array('user' => $user);
+
+        /** @var Mage_Core_Model_Email_Template $emailTemplate */
+        $emailTemplate = Mage::getModel('core/email_template');
+        $emailTemplate->setDesignConfig(array('area' => 'adminhtml', 'store' => 0));
+        $emailTemplate->sendTransactional($templateId, $sender, $email, $name, $vars);
+
+        return $this;
+    }
+
...
index 99311a5af23..3bcdc4a68ae 100644
...
index 2111fb10b53..13c48d521ca 100644
...
index 995b05afc4a..1a2d9e6f7c7 100644
--- app/code/core/Mage/Checkout/Model/Type/Onepage.php
+++ app/code/core/Mage/Checkout/Model/Type/Onepage.php
@@ -638,6 +638,7 @@ class Mage_Checkout_Model_Type_Onepage
...
index 16f12228b9c..20432981673 100644
--- app/code/core/Mage/Cms/Model/Wysiwyg/Images/Storage.php
+++ app/code/core/Mage/Cms/Model/Wysiwyg/Images/Storage.php
@@ -259,8 +259,9 @@ class Mage_Cms_Model_Wysiwyg_Images_Storage extends Varien_Object
         }
...
index 7db9706d0be..d28dbca4119 100644
...
index 9a2282f9758..9e8adf1279e 100644
...
index 04e6320c675..4cdc630b8cb 100644
...
@@ -1145,6 +1146,28 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
...
index 09c70ad9168..4591cb93c41 100644
...
index 4dc40eb31ae..a10ff12539e 100644
...
@@ -682,4 +721,144 @@ class Mage_Paypal_Model_Express_Checkout
         }
         return '';
     }
+
...
index 045627bb300..8ee0fee9837 100644
...
index 27214d76934..107364b8c09 100644
...
index 1b5c2d05817..3d997b82c20 100644
...
index 6618668be73..e9bef264708 100644
...
index d7c3bffe945..a5e66d0fc7a 100644
...
index dd40598dcb0..7e346fc2363 100755
--- downloader/Maged/Controller.php
+++ downloader/Maged/Controller.php
@@ -742,6 +742,18 @@ final class Maged_Controller
      */
