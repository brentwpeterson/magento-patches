...
SUPEE-8788 | EE_1.9.1.0 | v1 | c253444482858575519a4ca51a4c6a63b141c434 | Mon Sep 26 13:32:04 2016 +0300 | be9faf6545..c253444482
...
+        return Enterprise_PageCache_Helper_Data::wrapPlaceholderString('_SID_MARKER_');
     ...
     /**
@@ -64,6 +68,7 @@ class Enterprise_PageCache_Helper_Url
...
index f812976..8385ec0 100644
--- app/code/core/Enterprise/PageCache/Model/Processor.php
+++ app/code/core/Enterprise/PageCache/Model/Processor.php
@@ -268,6 +268,15 @@ class Enterprise_PageCache_Model_Processor
             $isProcessed = false;
         }
...
+
          ...
          */
@@ -348,6 +357,7 @@ class Enterprise_PageCache_Model_Processor
                  * Replace all occurrences of session_id with unique marker
                  */
                 Enterprise_PageCache_Helper_Url::replaceSid($content);
+                Enterprise_PageCache_Helper_Form_Key::replaceFormKey($content);
...
@@ -482,7 +492,13 @@ class Enterprise_PageCache_Model_Processor
          * Define request URI
          */
         if ($uri) {
...
index df902bb..f1c6b6e 100755
--- downloader/Maged/Controller.php
+++ downloader/Maged/Controller.php
@@ -343,6 +343,11 @@ final class Maged_Controller
      */
...
+
         if (!$_FILES) {
             echo "No file was uploaded";
             return;
@@ -885,4 +890,27 @@ final class Maged_Controller
             }
         }
     }
+
