...
SUPEE-8788 | EE_1.9.0.0 | v1 | 1fabd6d74fe4360c222a11c7e7c8675066fb2104 | Mon Sep 26 13:32:33 2016 +0300 | b13d395aef..1fabd6d74f
...
index bf4811a..878e4ba 100644
--- app/code/core/Enterprise/PageCache/Model/Observer.php
+++ app/code/core/Enterprise/PageCache/Model/Observer.php
@@ -476,4 +476,23 @@ class Enterprise_PageCache_Model_Observer
...
@@ -260,6 +264,23 @@ class Enterprise_PageCache_Model_Processor
         } else {
             $isProcessed = false;
         }
+
...
@@ -329,6 +350,12 @@ class Enterprise_PageCache_Model_Processor
...
@@ -341,6 +368,8 @@ class Enterprise_PageCache_Model_Processor
...
@@ -460,7 +489,13 @@ class Enterprise_PageCache_Model_Processor
          * Define request URI
          */
         if ($uri) {
...
index 273a88b..a6aa9eb 100644
--- app/code/core/Mage/Adminhtml/Model/System/Config/Backend/Serialized.php
+++ app/code/core/Mage/Adminhtml/Model/System/Config/Backend/Serialized.php
@@ -29,7 +29,17 @@ class Mage_Adminhtml_Model_System_Config_Backend_Serialized extends Mage_Core_Mo
...
@@ -312,13 +354,13 @@ abstract class Mage_Catalog_Block_Product_Abstract extends Mage_Core_Block_Templ
      *
      * @return string
      */
...
@@ -334,6 +350,11 @@ class Mage_Checkout_CartController extends Mage_Core_Controller_Front_Action
         $this->_goBack();
     }
...
@@ -597,7 +740,7 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
index 246f3c8..ff75a96 100644
--- app/code/core/Mage/Customer/controllers/AddressController.php
+++ app/code/core/Mage/Customer/controllers/AddressController.php
@@ -169,6 +169,9 @@ class Mage_Customer_AddressController extends Mage_Core_Controller_Front_Action
...
index 08c2b87..e6c6700 100644
--- app/code/core/Mage/Paygate/Model/Authorizenet.php
+++ app/code/core/Mage/Paygate/Model/Authorizenet.php
@@ -366,8 +366,10 @@ class Mage_Paygate_Model_Authorizenet extends Mage_Payment_Model_Method_Cc
...
index c62fb4a..7d9432b 100644
--- app/code/core/Mage/Usa/Model/Shipping/Carrier/Dhl.php
+++ app/code/core/Mage/Usa/Model/Shipping/Carrier/Dhl.php
@@ -393,8 +393,8 @@ class Mage_Usa_Model_Shipping_Carrier_Dhl
             $ch = curl_init();
             curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
...
@@ -967,8 +967,8 @@ class Mage_Usa_Model_Shipping_Carrier_Dhl
             $ch = curl_init();
             curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
             curl_setopt($ch, CURLOPT_URL, $url);
-            curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
...
index fc2819e..651d74b 100644
--- app/code/core/Mage/Usa/Model/Shipping/Carrier/Fedex.php
+++ app/code/core/Mage/Usa/Model/Shipping/Carrier/Fedex.php
@@ -411,8 +411,8 @@ class Mage_Usa_Model_Shipping_Carrier_Fedex
             $ch = curl_init();
             curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
             curl_setopt($ch, CURLOPT_URL, $url);
-            curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, 0);
...
index fa779de..3107807 100755
--- downloader/Maged/Controller.php
+++ downloader/Maged/Controller.php
@@ -341,6 +341,11 @@ final class Maged_Controller
      */
...
+
         if (!$_FILES) {
             echo "No file was uploaded";
             return;
@@ -861,4 +866,27 @@ final class Maged_Controller
             }
         }
     }
+
...
index 307f63c..6af2d10 100644
--- downloader/Maged/Model/Session.php
+++ downloader/Maged/Model/Session.php
@@ -195,4 +195,17 @@ class Maged_Model_Session extends Maged_Model
         }
...
index 30487b6..521e1d5 100644
--- downloader/lib/Mage/HTTP/Client/Curl.php
+++ downloader/lib/Mage/HTTP/Client/Curl.php
@@ -368,8 +368,8 @@ implements Mage_HTTP_IClient
         }
...
index bebdf21..19898f8 100644
--- downloader/template/connect/packages.phtml
+++ downloader/template/connect/packages.phtml
@@ -57,6 +57,7 @@
 <li><span class="step-count">1</span> &nbsp; Download or build package file.</li>
 <li><span class="step-count">2</span> &nbsp; Upload package file:
...
+        <input name="form_key" type="hidden" value="<?php echo $this->getFormKey() ?>" />
         ...
         <input type="file" id="file" name="file" style="width:300px"></input>
