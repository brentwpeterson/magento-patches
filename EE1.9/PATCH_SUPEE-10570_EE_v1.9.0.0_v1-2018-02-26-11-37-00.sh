...
SUPEE-10570_v1.9.0.0 | EE_1.9.0.0 | v1 | 761059371f6695a25a5a7906a2f3e70933598ddc | Sat Feb 17 04:54:51 2018 +0200 | ee-1.9.0.0-dev

__PATCHFILE_FOLLOWS__
diff --git app/Mage.php app/Mage.php
index 4cda844..c6c0c18 100644
--- app/Mage.php
+++ app/Mage.php
@@ -722,6 +722,7 @@ final class Mage
...
index cfe5370..a15339b 100644
--- app/code/core/Enterprise/Cms/Block/Adminhtml/Cms/Hierarchy/Edit/Form.php
+++ app/code/core/Enterprise/Cms/Block/Adminhtml/Cms/Hierarchy/Edit/Form.php
@@ -415,6 +415,7 @@ class Enterprise_Cms_Block_Adminhtml_Cms_Hierarchy_Edit_Form extends Mage_Adminh
             } else {
...
index 9bf0b76..fb10442 100644
--- app/code/core/Enterprise/Cms/Block/Adminhtml/Cms/Page/Edit/Tab/Hierarchy.php
+++ app/code/core/Enterprise/Cms/Block/Adminhtml/Cms/Page/Edit/Tab/Hierarchy.php
@@ -85,7 +85,7 @@ class Enterprise_Cms_Block_Adminhtml_Cms_Page_Edit_Tab_Hierarchy
                     $node = array(
                         'node_id'               => $v['node_id'],
...
@@ -105,7 +105,7 @@ class Enterprise_Cms_Block_Adminhtml_Cms_Page_Edit_Tab_Hierarchy
                     $node = array(
                         'node_id'               => $item->getId(),
...
index 843e30e..9c394c9 100644
--- app/code/core/Enterprise/Customer/Block/Adminhtml/Customer/Attribute/Edit/Tab/Main.php
+++ app/code/core/Enterprise/Customer/Block/Adminhtml/Customer/Attribute/Edit/Tab/Main.php
@@ -184,7 +184,7 @@ class Enterprise_Customer_Block_Adminhtml_Customer_Attribute_Edit_Tab_Main
...
@@ -194,7 +194,7 @@ class Enterprise_Customer_Block_Adminhtml_Customer_Attribute_Edit_Tab_Main
             }
...
@@ -209,7 +209,7 @@ class Enterprise_Customer_Block_Adminhtml_Customer_Attribute_Edit_Tab_Main
...
index cf0741f..e06bc17 100644
--- app/code/core/Enterprise/Logging/Model/Mysql4/Event/Collection.php
+++ app/code/core/Enterprise/Logging/Model/Mysql4/Event/Collection.php
@@ -58,11 +58,10 @@ class Enterprise_Logging_Model_Mysql4_Event_Collection extends Mage_Core_Model_M
...
+            Mage::getResourceHelper('enterprise_logging')->getInetNtoaExpr('ip') . ' like ?',
+            '%' . $value . '%'
         );
...
index ea7b9b6b..757280c2 100644
...
index 34d5f21..e0b9334 100644
--- app/code/core/Mage/Adminhtml/Block/Catalog/Category/Edit/Form.php
+++ app/code/core/Mage/Adminhtml/Block/Catalog/Category/Edit/Form.php
@@ -178,7 +178,9 @@ class Mage_Adminhtml_Block_Catalog_Category_Edit_Form extends Mage_Adminhtml_Blo
     public function getHeader()
     {
         if ($this->hasStoreRootCategory()) {
-            return $this->getCategoryId() ? $this->getCategoryName() : Mage::helper('catalog')->__('New Category');
+            return $this->getCategoryId()
+                ? $this->escapeHtml($this->getCategoryName())
+                : Mage::helper('catalog')->__('New Category');
         }
...
index b6df4ec..34daf67 100644
--- app/code/core/Mage/Adminhtml/controllers/Catalog/ProductController.php
+++ app/code/core/Mage/Adminhtml/controllers/Catalog/ProductController.php
@@ -671,6 +671,16 @@ class Mage_Adminhtml_Catalog_ProductController extends Mage_Adminhtml_Controller
...
index 3c1e1b1..8aa0716 100644
--- app/code/core/Mage/Adminhtml/controllers/CustomerController.php
+++ app/code/core/Mage/Adminhtml/controllers/CustomerController.php
@@ -296,6 +296,7 @@ class Mage_Adminhtml_CustomerController extends Mage_Adminhtml_Controller_Action
...
@@ -315,6 +317,26 @@ class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
     }
...
+    /**
      ...
      *
      * @return array
@@ -376,6 +398,23 @@ class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
...
@@ -410,6 +449,13 @@ class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
...
+                $customer->setPasswordCreatedAt(time());
                 ...
                 return;
@@ -793,6 +794,8 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
             }
...
@@ -28,7 +28,7 @@
 <config>
     <modules>
         <Mage_Customer>
-            <version>1.4.0.0.12</version>
+            <version>1.4.0.0.12.1.2</version>
         </Mage_Customer>
     </modules>
 
diff --git app/code/core/Mage/Customer/sql/customer_setup/mysql4-upgrade-1.4.0.0.12.1.1-1.4.0.0.12.1.2.php app/code/core/Mage/Customer/sql/customer_setup/mysql4-upgrade-1.4.0.0.12.1.1-1.4.0.0.12.1.2.php
new file mode 100644
index 0000000..477b391
--- /dev/null
+++ app/code/core/Mage/Customer/sql/customer_setup/mysql4-upgrade-1.4.0.0.12.1.1-1.4.0.0.12.1.2.php
@@ -0,0 +1,38 @@
+<?php
+/**
...
diff --git app/code/core/Mage/Downloadable/sql/downloadable_setup/mysql4-upgrade-1.4.0.1.1.1-1.4.0.1.1.2.php app/code/core/Mage/Downloadable/sql/downloadable_setup/mysql4-upgrade-1.4.0.1.1.1-1.4.0.1.1.2.php
new file mode 100644
index 0000000..7b06be2
--- /dev/null
+++ app/code/core/Mage/Downloadable/sql/downloadable_setup/mysql4-upgrade-1.4.0.1.1.1-1.4.0.1.1.2.php
@@ -0,0 +1,35 @@
+<?php
+/**
+ * Magento Enterprise Edition
