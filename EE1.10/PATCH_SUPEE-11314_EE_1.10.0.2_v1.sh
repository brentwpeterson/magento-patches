...
SUPEE-11314_EE_11002 | EE_1.10.0.2 | v1 | 10d88da98eb1900c93b3be42346f9dc49ebc21fd | Wed Apr 15 13:58:03 2020 +0000 | df16569d1ba687182d358b7bad1e807f7460b521..HEAD

__PATCHFILE_FOLLOWS__
diff --git app/code/core/Enterprise/Pci/Model/Encryption.php app/code/core/Enterprise/Pci/Model/Encryption.php
index e5cc3edb9f4..ce087968819 100644
...
index 2f2cb491ae4..c035273b35b 100644
--- app/code/core/Enterprise/Pci/Model/Observer.php
+++ app/code/core/Enterprise/Pci/Model/Observer.php
@@ -108,15 +108,18 @@ class Enterprise_Pci_Model_Observer
             }
         }
...
@@ -130,9 +133,16 @@ class Enterprise_Pci_Model_Observer
...
@@ -157,7 +167,6 @@ class Enterprise_Pci_Model_Observer
...
@@ -165,7 +174,7 @@ class Enterprise_Pci_Model_Observer
                 break;
             }
         }
...
index 990fdb444a6..2df7f06f0df 100644
--- app/code/core/Mage/Admin/Model/Observer.php
+++ app/code/core/Mage/Admin/Model/Observer.php
@@ -111,4 +111,29 @@ class Mage_Admin_Model_Observer
...
index 8a10c2de4f5..cfefe5e6bbf 100644
...
@@ -300,4 +312,14 @@ class Mage_Admin_Model_Session extends Mage_Core_Model_Session_Abstract
...
index 315905d84f6..7bcbbc81da8 100644
--- app/code/core/Mage/Api/Model/User.php
+++ app/code/core/Mage/Api/Model/User.php
@@ -211,7 +211,7 @@ class Mage_Api_Model_User extends Mage_Core_Model_Abstract
...
index 14d55530d1b..d4ebce545a2 100644
...
index 755a3b7f04c..5a1e15925aa 100644
...
index 3f648a1fa21..4fdabd7c545 100644
--- app/code/core/Mage/Customer/Model/Customer.php
+++ app/code/core/Mage/Customer/Model/Customer.php
@@ -341,7 +341,7 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
      */
...
index 324e963d5b8..68f9e7db27e 100644
--- app/code/core/Mage/Customer/Model/Observer.php
+++ app/code/core/Mage/Customer/Model/Observer.php
@@ -38,4 +38,44 @@ class Mage_Customer_Model_Observer
...
index b8223902696..938f2971046 100644
...
index 7c74a82ab7f..f910083b95f 100644
--- app/code/core/Mage/Dataflow/Model/Profile.php
+++ app/code/core/Mage/Dataflow/Model/Profile.php
@@ -134,7 +134,10 @@ class Mage_Dataflow_Model_Profile extends Mage_Core_Model_Abstract
                     $uploader->save($path);
...
index 2fa67de59b3..84ef23e8782 100644
...
index 3509da730a6..8a40ebaaa67 100644
...
index 263f48956d3..e1d55bb1c79 100644
...
index f9dd58e5869..7b25fe8a962 100644
...
index 66f880823e6..8d215bc0b1c 100644
...
index 1e10460015e..b818615608e 100644
...
index a10609d7c88..7e363f167a6 100644
...
index a77fde64c0c..403c1779e47 100644
...
index fb6dd2cdc99..032e08053a6 100644
...
@@ -250,5 +252,12 @@ $isVisibleProduct = $_item->getProduct()->isVisibleInSiteVisibility();
         <?php endif; ?>
     </td>
     <?php endif; ?>
...
index c5acf5eef21..8dea3a58307 100644
...
index 16009b81030..7fe3b11edce 100644
...
index 7191387c93c..4e72ec090d9 100644
...
index 281143fa34e..5df92f4740f 100644
...
index 49faee20678..fa63208a50e 100644
...
index 26c3da04bf3..6a647e11e03 100644
...
index 8fd4301c799..cef77c600e9 100644
...
index cddd6a027f2..0e147359790 100644
...
index 92d73eb7895..bb37cad2d0b 100644
...
index cafb46977e9..f56b625b216 100644
...
index bcc91251802..e3540d2bc9e 100644
...
index 0e7fa13e4da..6291bcfa79a 100644
...
index 5e90eb26d16..de167509abc 100644
...
-                        <button type="button" title="<?php echo $this->__('Add to Cart') ?>" onclick="setLocation('<?php echo $this->getAddToCartUrl($item) ?>')" class="button btn-cart"><span><span><?php echo $this->__('Add to Cart') ?></span></span></button>
-                    <?php endif;?>
...
index 51eb078ee2e..79184fe4a90 100644
...
+    <?php foreach ($this->getWishlistItems() as $_item): ?>
         ...
         <li class="item">
             <a href="<?php echo $this->getProductUrl($_item) ?>" title="<?php echo $this->htmlEscape($product->getName()) ?>" class="product-image"><img src="<?php echo $this->helper('catalog/image')->init($product, 'thumbnail')->resize(50); ?>" width="50" height="50" alt="<?php echo $this->htmlEscape($product->getName()) ?>" /></a>
             <div class="product-details">
...
-                <p class="product-name"><a href="<?php echo $this->getProductUrl($_item) ?>"><?php echo $this->htmlEscape($product->getName()) ?></a></p>
+                <a href="#"
+                   class="btn-remove"
...
index 5d777f5623e..33045fd11f6 100644
--- app/design/frontend/enterprise/default/layout/catalog.xml
+++ app/design/frontend/enterprise/default/layout/catalog.xml
@@ -193,8 +193,9 @@ Product view
         <reference name="head">
...
index f30c5880477..78d13f28b0a 100644
...
index dde352cd2ea..e83894f2410 100644
...
index 03f0c60e8dd..a46db1b88dc 100644
--- skin/frontend/enterprise/default/css/styles.css
+++ skin/frontend/enterprise/default/css/styles.css
@@ -1025,9 +1025,9 @@ ul.disc li { padding-left:10px; background:url(../images/bkg_bulletsm.gif) no-re
...
@@ -1064,6 +1064,9 @@ p.product-image { cursor:default !important; }
