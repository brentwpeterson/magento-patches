...
SUPEE-8788 | EE_1.10.0.1 | v1 | 0779ff1bcacc6f4d6eda9c4d9dc2dfaab11cf028 | Mon Sep 26 13:20:33 2016 +0300 | 867dd4db09..0779ff1bca
...
index ac0c6fc..0262c52 100644
--- app/code/core/Enterprise/PageCache/Model/Observer.php
+++ app/code/core/Enterprise/PageCache/Model/Observer.php
@@ -486,4 +486,23 @@ class Enterprise_PageCache_Model_Observer
...
index 874e676..9ce8298 100644
--- app/code/core/Enterprise/PageCache/Model/Processor.php
+++ app/code/core/Enterprise/PageCache/Model/Processor.php
@@ -299,6 +299,15 @@ class Enterprise_PageCache_Model_Processor
             $isProcessed = false;
         }
...
+
          ...
          */
@@ -379,6 +388,7 @@ class Enterprise_PageCache_Model_Processor
                  * Replace all occurrences of session_id with unique marker
                  */
                 Enterprise_PageCache_Helper_Url::replaceSid($content);
+                Enterprise_PageCache_Helper_Form_Key::replaceFormKey($content);
...
@@ -516,7 +526,13 @@ class Enterprise_PageCache_Model_Processor
          * Define request URI
          */
         if ($uri) {
...
diff --git app/code/core/Mage/Core/Input/Filter/MaliciousCode.php app/code/core/Mage/Core/Input/Filter/MaliciousCode.php
new file mode 100644
