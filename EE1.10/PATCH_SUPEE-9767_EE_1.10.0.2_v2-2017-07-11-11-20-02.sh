...
PATCH_SUPEE-9767_EE_1.10.0.2_v2 | EE_1.10.0.2 | v2 | 6566db274beaeb9bcdb56a62e02cc2da532e618c | Thu Jun 22 04:30:03 2017 +0300 | v1.14.3.3..HEAD
...
index 0262c52..8a7b12a 100644
--- app/code/core/Enterprise/PageCache/Model/Observer.php
+++ app/code/core/Enterprise/PageCache/Model/Observer.php
@@ -313,7 +313,7 @@ class Enterprise_PageCache_Model_Observer
...
+        return $this;
     ...
     /**
@@ -365,6 +365,8 @@ class Enterprise_PageCache_Model_Observer
...
@@ -380,6 +382,7 @@ class Enterprise_PageCache_Model_Observer
             return $this;
         }
...
@@ -406,6 +409,7 @@ class Enterprise_PageCache_Model_Observer
...
@@ -498,11 +502,17 @@ class Enterprise_PageCache_Model_Observer
             return;
         }
...
index 9ce8298..918d70d 100644
--- app/code/core/Enterprise/PageCache/Model/Processor.php
+++ app/code/core/Enterprise/PageCache/Model/Processor.php
@@ -299,11 +299,9 @@ class Enterprise_PageCache_Model_Processor
             $isProcessed = false;
         }
...
index 2663473..b0341e3 100644
--- app/code/core/Mage/Adminhtml/controllers/IndexController.php
+++ app/code/core/Mage/Adminhtml/controllers/IndexController.php
@@ -73,8 +73,10 @@ class Mage_Adminhtml_IndexController extends Mage_Adminhtml_Controller_Action
...
@@ -424,6 +440,11 @@ class Mage_Checkout_OnepageController extends Mage_Checkout_Controller_Action
         if ($this->_expireAjax()) {
             return;
         }
+
...
index 26fd4d4..67d6592 100644
--- app/code/core/Mage/Core/Model/Session/Abstract/Varien.php
+++ app/code/core/Mage/Core/Model/Session/Abstract/Varien.php
@@ -355,13 +355,19 @@ class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
...
@@ -405,4 +411,15 @@ class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
...
@@ -220,6 +223,7 @@ class Mage_Customer_Model_Session extends Mage_Core_Model_Session_Abstract
...
index c57c994..c08f1d9 100644
--- app/design/adminhtml/default/default/layout/main.xml
+++ app/design/adminhtml/default/default/layout/main.xml
@@ -118,6 +118,7 @@ Default layout, loads most of the pages
