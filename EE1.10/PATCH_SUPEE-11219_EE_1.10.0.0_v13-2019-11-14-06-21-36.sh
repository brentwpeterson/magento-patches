...
SUPEE-11219_EE_11000 | CE_1.5.0.0 | v1 | da2ce583c13891b6a9bcaacf62903a3155dbae22 | Mon Nov 4 21:05:00 2019 +0000 | 067646b05fda4da5fd583e0604258865d92000d1..HEAD
...
index 294d0bb8fcd..f1574773991 100644
...
index 79979b29429..acc1443bfa5 100644
--- app/code/core/Mage/Adminhtml/Model/LayoutUpdate/Validator.php
+++ app/code/core/Mage/Adminhtml/Model/LayoutUpdate/Validator.php
@@ -52,21 +52,19 @@ class Mage_Adminhtml_Model_LayoutUpdate_Validator extends Zend_Validate_Abstract
      *
      * @var array
      */
...
+    protected $_validator = null;
     ...
     /**
      * Construct
@@ -74,26 +72,17 @@ class Mage_Adminhtml_Model_LayoutUpdate_Validator extends Zend_Validate_Abstract
...
+        return $this->_validator->getMessages();
     ...
     /**
@@ -110,39 +99,42 @@ class Mage_Adminhtml_Model_LayoutUpdate_Validator extends Zend_Validate_Abstract
      */
...
+        return $this;
     ...
     /**
@@ -150,8 +142,9 @@ class Mage_Adminhtml_Model_LayoutUpdate_Validator extends Zend_Validate_Abstract
      *
...
+        return $this->_validator->getXpathValidationExpression();
     ...
     /**
@@ -162,10 +155,6 @@ class Mage_Adminhtml_Model_LayoutUpdate_Validator extends Zend_Validate_Abstract
      */
...
index 26ee3617177..4927e078a9c 100644
...
index 79a81a2173c..a537022827d 100644
...
index e5acd044036..623dea5da11 100644
...
index 96c18df7f50..e36a4184fdc 100644
...
index 92cd39ce10d..f16abde7743 100644
...
index 8bd6b77f07c..390ffc933e2 100644
...
index 3e361c58cc3..5c4ba3e8226 100644
...
index 11b833953ba..d81fd77a9de 100644
...
index 544f8570af3..a29c53812e1 100644
...
index 6dd2f1d6de7..7823de73fac 100644
...
index 4449942ca01..e874399e55d 100644
...
@@ -738,12 +748,10 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
...
+                ->__('The minimum password length is %s', $minPasswordLength);
         ...
         if (
             strlen($password)
@@ -1171,4 +1179,16 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
         }
...
index fa30ef0277b..06cfd1772b0 100644
--- app/code/core/Mage/Customer/controllers/AccountController.php
+++ app/code/core/Mage/Customer/controllers/AccountController.php
@@ -761,14 +761,7 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
index d6b32dd4f99..201fa6cb99c 100644
...
index 53a7a70d9ae..01d9d844409 100644
...
index c2df5f68394..4e8c7bdca2e 100644
...
index 2485ac0b1eb..85a5ed263af 100644
...
index 5179982823a..35d6c0a82dc 100644
...
+        return $this->getAddToCartUrlCustom($item);
     ...
     /**
@@ -470,4 +439,78 @@ class Mage_Wishlist_Helper_Data extends Mage_Core_Helper_Abstract
     {
...
index 43f7c952ad1..a7e1aa6dff0 100644
...
index cd980c524b2..857df03f4aa 100644
...
index 87c138e7621..39d5d7e47d4 100644
...
index ef71e0c6ad4..a6ade43d775 100644
...
index a8d70dd5a8c..46a720e8f02 100644
...
index 1ec70aa1903..34ae584665f 100644
--- js/varien/js.js
+++ js/varien/js.js
...
index 63c7ac025b5..bdcb9f612df 100644
...
index dd5e2ef7c98..a7c6b07188c 100644
