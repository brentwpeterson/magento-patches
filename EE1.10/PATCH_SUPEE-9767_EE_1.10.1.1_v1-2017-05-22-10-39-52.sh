...
PATCH_SUPEE-9767_EE_1.10.1.1_v1.sh | EE_1.10.1.1 | v1 | 226caf7 | Mon Feb 20 17:33:39 2017 +0200 | 2321b14

__PATCHFILE_FOLLOWS__
diff --git app/Mage.php app/Mage.php
index 3f05cae..cf41afb 100644
--- app/Mage.php
+++ app/Mage.php
...
+ */
 ...
 {
     /*
@@ -32,10 +39,24 @@ class Enterprise_PageCache_Model_Observer
...
+     */
     ...
     /**
@@ -50,6 +71,7 @@ class Enterprise_PageCache_Model_Observer
...
@@ -79,7 +101,8 @@ class Enterprise_PageCache_Model_Observer
     /**
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -99,9 +122,15 @@ class Enterprise_PageCache_Model_Observer
         }
         /**
...
+            Mage::app()->getCacheInstance()->banUse(Mage_Core_Block_Abstract::CACHE_GROUP);
         ...
         return $this;
@@ -132,13 +161,15 @@ class Enterprise_PageCache_Model_Observer
     /**
...
@@ -146,12 +177,14 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -173,6 +206,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -194,6 +228,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -201,13 +236,15 @@ class Enterprise_PageCache_Model_Observer
             return $this;
         }
         $object = $observer->getEvent()->getObject();
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -215,11 +252,14 @@ class Enterprise_PageCache_Model_Observer
             return $this;
         }
         $object = $observer->getEvent()->getObject();
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -229,6 +269,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -240,6 +281,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -249,6 +291,7 @@ class Enterprise_PageCache_Model_Observer
...
@@ -262,6 +305,7 @@ class Enterprise_PageCache_Model_Observer
      *
      * @param Varien_Event_Observer $observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -280,6 +324,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -303,6 +348,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -348,6 +394,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -359,18 +406,12 @@ class Enterprise_PageCache_Model_Observer
     }
...
-        // update customer viewed products index
         try {
             ...
             if ($productIds) {
@@ -391,16 +432,32 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -408,6 +465,14 @@ class Enterprise_PageCache_Model_Observer
             return $this;
         }
         $this->_getCookie()->updateCustomerCookies();
+
...
@@ -415,6 +480,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -441,6 +507,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -460,6 +527,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -474,6 +542,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -528,8 +597,19 @@ class Enterprise_PageCache_Model_Observer
...
@@ -155,7 +159,7 @@ class Mage_Admin_Model_Session extends Mage_Core_Model_Session_Abstract
...
+    public function refreshAcl($user = null)
     {
         if (is_null($user)) {
             $user = $this->getUser();
@@ -183,14 +187,14 @@ class Mage_Admin_Model_Session extends Mage_Core_Model_Session_Abstract
...
+     * Initializing layout messages by message storage(s), loading and adding messages to layout messages block
      ...
      * @return Mage_Core_Controller_Varien_Action
@@ -638,7 +664,7 @@ abstract class Mage_Core_Controller_Varien_Action
     }
...
+     * Initializing layout messages by message storage(s), loading and adding messages to layout messages block
      ...
      * @param string|array $messagesStorage
      * @return Mage_Core_Controller_Varien_Action
@@ -666,8 +692,30 @@ abstract class Mage_Core_Controller_Varien_Action
      * @param   string $path
...
index 6a11266..d776f59 100644
--- app/code/core/Mage/Core/Helper/Url.php
+++ app/code/core/Mage/Core/Helper/Url.php
@@ -105,6 +105,28 @@ class Mage_Core_Helper_Url extends Mage_Core_Helper_Abstract
     }
...
+        return Mage_Customer_Model_Group::NOT_LOGGED_IN_ID;
     ...
     /**
@@ -191,6 +225,8 @@ class Mage_Customer_Model_Session extends Mage_Core_Model_Session_Abstract
...
@@ -220,8 +256,7 @@ class Mage_Customer_Model_Session extends Mage_Core_Model_Session_Abstract
     {
         if ($this->isLoggedIn()) {
...
@@ -230,18 +265,93 @@ class Mage_Customer_Model_Session extends Mage_Core_Model_Session_Abstract
...
+        );
     ...
     /**
@@ -941,8 +981,8 @@ final class Maged_Controller
             'minor'     => '5',
             'revision'  => '0',
             'patch'     => '0',
-            'stability' => 'rc',
