...
SUPEE-11219_CE_1600 | CE_1.6.0.0 | v1 | ba7d4e4c80dd4e9ca9960949058a26e0f0dcdc69 | Tue Nov 12 19:39:51 2019 +0000 | 8e7bb70023b8f07bfe6734fc49d15e55c3353ee6..HEAD

__PATCHFILE_FOLLOWS__
diff --git app/code/core/Mage/Admin/Helper/Data.php app/code/core/Mage/Admin/Helper/Data.php
index c65629227df..c119fa09fd2 100644
...
index 0fa51d03a69..0022d562c57 100644
...
@@ -347,7 +367,7 @@ class Mage_Admin_Model_User extends Mage_Core_Model_Abstract
...
+        return Mage::helper('core')->getHashPassword($pwd, self::HASH_SALT_LENGTH);
     ...
     /**
@@ -446,15 +466,23 @@ class Mage_Admin_Model_User extends Mage_Core_Model_Abstract
         }
...
@@ -522,4 +550,16 @@ class Mage_Admin_Model_User extends Mage_Core_Model_Abstract
...
index c9ce82425a4..5065be6038b 100644
...
index 3648d2ef9b5..b82bdd8bb0a 100644
...
index 7512df45efe..0ad88af9854 100644
...
index b34beba4cc2..1451242c65e 100644
...
index 59b14472d6b..089c1a99981 100644
...
index 2011cf0a0ab..f1717f99393 100644
...
index ff7c7cbd945..b26a36765fb 100644
...
index 6c3408a21cc..f2f2d749e64 100644
...
index c55cc7ac22f..d1c6e3e93d4 100644
...
index 777ea07848c..50a19014053 100644
...
index 7073a23872d..151e825f70f 100644
...
+
      ...
      */
@@ -333,7 +344,7 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
      */
...
+        return Mage::helper('core')->getHashPassword(trim($password), (bool) $salt ? $salt : Mage_Admin_Model_User::HASH_SALT_LENGTH);
     ...
     /**
@@ -344,6 +355,10 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
      */
...
@@ -739,8 +754,9 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
...
@@ -1220,4 +1236,16 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
         }
...
index a02b222ab71..2dff9244290 100644
...
index 0f7b72a5150..5c3a3c3bf78 100644
...
index 107894e14a2..89f2deb39c5 100644
...
index 5f883478af4..de76871c15a 100644
...
index 6c7b480eb5d..c0511e6957d 100644
...
index 21ad232962e..8d002b6aa92 100644
...
index 1e6c55ee61f..1a4c86780ea 100644
...
index dea0bdc229c..2484e513221 100644
...
index 915a90c3262..e28c6bc364d 100644
...
index 49c7f8b5def..7a66ec25694 100644
