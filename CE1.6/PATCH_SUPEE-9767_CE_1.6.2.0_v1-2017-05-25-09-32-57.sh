...
PATCH_SUPEE-9767_CE_1.6.2.0_v1.sh | CE_1.6.2.0 | v1 | 226caf7 | Mon Feb 20 17:33:39 2017 +0200 | 2321b14

__PATCHFILE_FOLLOWS__
diff --git app/Mage.php app/Mage.php
index 4922234..852367e 100644
--- app/Mage.php
+++ app/Mage.php
...
+++ app/code/core/Mage/Admin/Model/Session.php
@@ -139,6 +139,9 @@ public function login($username, $password, $request = null)
             }
         }
...
@@ -428,6 +448,11 @@ public function savePaymentAction()
         if ($this->_expireAjax()) {
             return;
         }
+
...
@@ -146,10 +156,36 @@ protected function _prepareDownloadResponse($fileName, $content, $contentType =
                 if (!empty($content['rm'])) {
                     $ioAdapter->rm($file);
                 }
+
...
+            } elseif ((null !== $baseUrl) && (false === $pathInfo)) {
                 ...
                 $pathInfo = $requestUri;
@@ -312,7 +315,7 @@ public function getHttpHost($trimPort = true)
     /**
...
@@ -585,7 +611,7 @@ public function noCookiesAction()
      * @param string $action
...
+     * @param array|null $params
     ...
     {
@@ -593,15 +619,15 @@ protected function _forward($action, $controller = null, $module = null, array $
...
+     * Initializing layout messages by message storage(s), loading and adding messages to layout messages block
      ...
      * @return Mage_Core_Controller_Varien_Action
@@ -639,7 +665,7 @@ protected function _initLayoutMessages($messagesStorage)
     }
...
+     * Initializing layout messages by message storage(s), loading and adding messages to layout messages block
      ...
      * @param string|array $messagesStorage
      * @return Mage_Core_Controller_Varien_Action
@@ -666,9 +692,32 @@ protected function _redirectUrl($url)
      *
      * @param   string $path
...
@@ -677,6 +726,7 @@ protected function _redirect($path, $arguments=array())
...
+     * @return Mage_Core_Controller_Varien_Action
     ...
     {
@@ -695,6 +745,7 @@ protected function _redirectSuccess($defaultUrl)
...
+     * @return  Mage_Core_Controller_Varien_Action
     ...
     {
@@ -710,7 +761,7 @@ protected function _redirectError($defaultUrl)
     }
...
+     * Set referer url for redirect in response
      ...
      * @param   string $defaultUrl
      * @return  Mage_Core_Controller_Varien_Action
@@ -880,6 +931,7 @@ protected function _validateFormKey()
      *
...
@@ -985,7 +1037,7 @@ protected function _filterDateTime($array, $dateFields)
     }
...
index 0d3b8ad..8b3e4a2 100644
--- app/code/core/Mage/Core/Controller/Varien/Front.php
+++ app/code/core/Mage/Core/Controller/Varien/Front.php
@@ -296,8 +296,12 @@ protected function _checkBaseUrl($request)
...
@@ -310,23 +314,19 @@ protected function _checkBaseUrl($request)
             return;
         }
...
index 9d83532..8db9796 100644
--- app/code/core/Mage/Core/Controller/Varien/Router/Standard.php
+++ app/code/core/Mage/Core/Controller/Varien/Router/Standard.php
@@ -426,7 +426,7 @@ public function rewrite(array $p)
...
index ccf8d0b..4516eb2 100644
--- app/code/core/Mage/Core/Model/Url.php
+++ app/code/core/Mage/Core/Model/Url.php
@@ -1054,6 +1054,38 @@ protected function _prepareSessionUrl($url)
     }
...
@@ -96,7 +101,7 @@ public function getGroups()
     }
...
+     * Retrieve current (logged in) customer object
      ...
      */
@@ -136,21 +141,32 @@ public function customerHasAddresses()
      */
...
+++ app/code/core/Mage/Customer/Model/Session.php
@@ -86,9 +86,7 @@ public function setCustomer(Mage_Customer_Model_Customer $customer)
...
@@ -102,7 +100,7 @@ public function setCustomer(Mage_Customer_Model_Customer $customer)
     }
...
+     * Retrieve customer model object
      ...
      * @return Mage_Customer_Model_Customer
      */
@@ -170,11 +168,14 @@ public function getCustomerGroupId()
...
+     * Checking customer login status
      ...
      * @return bool
      */
@@ -221,6 +222,8 @@ public function login($username, $password)
...
@@ -250,8 +253,7 @@ public function logout()
     {
         if ($this->isLoggedIn()) {
...
@@ -260,19 +262,25 @@ public function logout()
...
+        return false;
     ...
     /**
@@ -286,10 +294,26 @@ protected function _setAuthUrl($key, $url)
     {
...
+    /**
      ...
      *
      * @param string $url
@@ -310,4 +334,17 @@ public function setAfterAuthUrl($url)
     {
...
+++ app/code/core/Mage/Widget/Model/Widget/Instance.php
@@ -340,7 +340,11 @@ public function getStoreIds()
...
@@ -904,25 +904,36 @@ public function endInstall()
         }
     }
