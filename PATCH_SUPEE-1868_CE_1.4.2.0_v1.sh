...
SUPEE-1868 | CE_1.4.2.0 | v1 | _ | n/a | SUPEE-1868_CE_1.4.2.0_v1.patch

__PATCHFILE_FOLLOWS__
diff --git app/code/core/Mage/Paypal/Model/Express/Checkout.php app/code/core/Mage/Paypal/Model/Express/Checkout.php
index ffc1940..9dc4ab4 100644
--- app/code/core/Mage/Paypal/Model/Express/Checkout.php
+++ app/code/core/Mage/Paypal/Model/Express/Checkout.php
@@ -599,7 +599,7 @@ class Mage_Paypal_Model_Express_Checkout
                 }
...
+    }
+}
diff --git app/etc/applied.patches.list app/etc/applied.patches.list
index 0000000..ebf7560 100644
--- app/etc/applied.patches.list
+++ app/etc/applied.patches.list
@@ -0,0 +1 @@
+2013-07-28 16:20:05 UTC | SUPEE-1868 | EE_1.9.0.0 | v1 | _ | n/a | SUPEE-1868_EE_1.9.0.0_v1.patch
