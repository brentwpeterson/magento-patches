...
SUPEE-11219_CE_1500 | CE_1.5.0.0 | v1 | f52f32be2f1160c2943428630d48175ebacae346 | Thu Nov 7 21:10:22 2019 +0000 | 237424efa885e8d73b9cdaca94e5a363f7812202..HEAD
...
index 74a3bcfad9c..a4ac3a6a23c 100644
...
@@ -77,6 +81,7 @@ class Mage_Adminhtml_Block_Customer_Edit_Tab_Account extends Mage_Adminhtml_Bloc
...
@@ -89,7 +94,9 @@ class Mage_Adminhtml_Block_Customer_Edit_Tab_Account extends Mage_Adminhtml_Bloc
                     array(
...
@@ -126,9 +133,11 @@ class Mage_Adminhtml_Block_Customer_Edit_Tab_Account extends Mage_Adminhtml_Bloc
...
index eefe9f60bbd..e90a72bd1da 100644
...
@@ -247,13 +251,13 @@ class Mage_Adminhtml_Model_Config_Data extends Varien_Object
...
+            $scope   = self::SCOPE_DEFAULT;
         ...
         $this->setScope($scope);
@@ -299,4 +303,100 @@ class Mage_Adminhtml_Model_Config_Data extends Varien_Object
         }
         return $config;
     }
+
...
index 4f7e38e1e01..f84176071ac 100644
...
index bf3f0f0f9ac..f76e2db8dc4 100644
...
index 20726a62101..5fa9a9c4e54 100644
...
index 77eb366607d..2b7bb09c9bc 100644
...
index 86f16ed9200..bfc9358bfb1 100644
--- app/code/core/Mage/Adminhtml/controllers/Sales/OrderController.php
+++ app/code/core/Mage/Adminhtml/controllers/Sales/OrderController.php
@@ -737,4 +737,15 @@ class Mage_Adminhtml_Sales_OrderController extends Mage_Adminhtml_Controller_Act
             $this->_redirect('*/*/');
         }
     }
+
...
index 605550b8eee..93dfd37a391 100644
...
index c69798774a3..45dd839b7ac 100644
...
index 434034d349b..b87ef561961 100644
--- app/code/core/Mage/Catalog/Block/Product/Abstract.php
+++ app/code/core/Mage/Catalog/Block/Product/Abstract.php
@@ -107,15 +107,7 @@ abstract class Mage_Catalog_Block_Product_Abstract extends Mage_Core_Block_Templ
      */
...
+        return $this->getSubmitUrlCustom($product, $additional);
     ...
     /**
@@ -126,7 +118,7 @@ abstract class Mage_Catalog_Block_Product_Abstract extends Mage_Core_Block_Templ
      */
...
+        return $this->getAddToWishlistUrlCustom($product);
     ...
     /**
@@ -137,7 +129,7 @@ abstract class Mage_Catalog_Block_Product_Abstract extends Mage_Core_Block_Templ
      */
...
@@ -499,6 +491,36 @@ abstract class Mage_Catalog_Block_Product_Abstract extends Mage_Core_Block_Templ
...
+
      ...
      *
@@ -518,4 +540,64 @@ abstract class Mage_Catalog_Block_Product_Abstract extends Mage_Core_Block_Templ
...
index c9a1052d881..66c5d11f903 100644
--- app/code/core/Mage/Catalog/Block/Product/View.php
+++ app/code/core/Mage/Catalog/Block/Product/View.php
@@ -226,4 +226,34 @@ class Mage_Catalog_Block_Product_View extends Mage_Catalog_Block_Product_Abstrac
...
index f17c55cdc25..553f4d0e6d0 100644
--- app/code/core/Mage/Catalog/Helper/Product/Compare.php
+++ app/code/core/Mage/Catalog/Helper/Product/Compare.php
@@ -93,10 +93,7 @@ class Mage_Catalog_Helper_Product_Compare extends Mage_Core_Helper_Url
      */
...
+        return $this->_getUrlCustomParams($product);
     ...
     /**
@@ -107,7 +104,7 @@ class Mage_Catalog_Helper_Product_Compare extends Mage_Core_Helper_Url
      */
...
+        return $this->getAddUrlCustom($product);
     ...
     /**
@@ -118,14 +115,7 @@ class Mage_Catalog_Helper_Product_Compare extends Mage_Core_Helper_Url
      */
     public function getAddToWishlistUrl($product)
     {
...
+        return $this->getAddToWishlistUrlCustom($product);
     ...
     /**
@@ -136,13 +126,7 @@ class Mage_Catalog_Helper_Product_Compare extends Mage_Core_Helper_Url
      */
...
+        return $this->getAddToCartUrlCustom($product);
     ...
     /**
@@ -288,4 +272,71 @@ class Mage_Catalog_Helper_Product_Compare extends Mage_Core_Helper_Url
     {
...
index 0491f824199..d5be43e6f43 100644
...
@@ -28,7 +28,7 @@
 <config>
     <modules>
         <Mage_Catalog>
-            <version>1.4.0.0.43</version>
+            <version>1.4.0.0.43.1.2</version>
         </Mage_Catalog>
     </modules>
 
diff --git app/code/core/Mage/Catalog/sql/catalog_setup/mysql4-upgrade-1.4.0.0.43.1.1-1.4.0.0.43.1.2.php app/code/core/Mage/Catalog/sql/catalog_setup/mysql4-upgrade-1.4.0.0.43.1.1-1.4.0.0.43.1.2.php
new file mode 100644
index 00000000000..d2863c47aa5
--- /dev/null
+++ app/code/core/Mage/Catalog/sql/catalog_setup/mysql4-upgrade-1.4.0.0.43.1.1-1.4.0.0.43.1.2.php
@@ -0,0 +1,44 @@
+<?php
+/**
+ * Magento
...
index d3520adb2d7..19dfc3b2a6d 100644
--- app/code/core/Mage/Checkout/Helper/Cart.php
+++ app/code/core/Mage/Checkout/Helper/Cart.php
@@ -51,29 +51,7 @@ class Mage_Checkout_Helper_Cart extends Mage_Core_Helper_Url
      */
...
+        return $this->getAddUrlCustom($product, $additional);
     ...
     /**
@@ -161,4 +139,39 @@ class Mage_Checkout_Helper_Cart extends Mage_Core_Helper_Url
     {
...
+        );
+        if ($addFormKey) {
+            $routeParams[Mage_Core_Model_Url::FORM_KEY] = Mage::getModel('core/session')->getFormKey();
+        }
+        if (!empty($additional)) {
+            $routeParams = array_merge($routeParams, $additional);
+        }
...
index 3a275a34056..f68c5b97f5c 100644
...
index b8609dbe667..73addab1382 100644
--- app/code/core/Mage/Core/Block/Abstract.php
+++ app/code/core/Mage/Core/Block/Abstract.php
@@ -1187,6 +1187,16 @@ abstract class Mage_Core_Block_Abstract extends Varien_Object
...
+
      ...
      *
@@ -1214,4 +1224,14 @@ abstract class Mage_Core_Block_Abstract extends Varien_Object
...
index cd21305bced..d152f75d983 100644
--- app/code/core/Mage/Core/Controller/Request/Http.php
+++ app/code/core/Mage/Core/Controller/Request/Http.php
@@ -257,9 +257,9 @@ class Mage_Core_Controller_Request_Http extends Zend_Controller_Request_Http
         return $path;
     }
...
index 1b869916363..c145c9d8211 100644
--- app/code/core/Mage/Core/Helper/Data.php
+++ app/code/core/Mage/Core/Helper/Data.php
@@ -247,11 +247,41 @@ class Mage_Core_Helper_Data extends Mage_Core_Helper_Abstract
...
index 6436233f23d..27aa0a721b4 100644
...
index 17b0ca11714..2a8b7c59c7e 100644
...
index e335b254cac..b01fecba325 100644
...
+
      ...
      *
@@ -59,4 +66,25 @@ class Mage_Core_Model_File_Uploader extends Varien_File_Uploader
...
index 4da38ce12fe..ac5d8ec0d0f 100644
...
index 02560b4ea7e..9f2c15142d2 100644
...
index 3a0c07f10dc..c4ee86b4c2c 100644
...
@@ -734,8 +749,9 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
...
@@ -1182,4 +1198,16 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
         }
...
index 1515ac56924..c413bf0c06b 100644
--- app/code/core/Mage/Customer/controllers/AccountController.php
+++ app/code/core/Mage/Customer/controllers/AccountController.php
@@ -624,14 +624,7 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
index 5861645161c..86fd8532403 100644
...
index a3af1ef180d..9e7606022d6 100644
--- app/code/core/Mage/Dataflow/Model/Convert/Container/Abstract.php
+++ app/code/core/Mage/Dataflow/Model/Convert/Container/Abstract.php
@@ -47,6 +47,11 @@ abstract class Mage_Dataflow_Model_Convert_Container_Abstract
...
index 83d30a6a1bf..e4e20b4239d 100644
...
index 4349a8d9af1..5d21e226ba7 100644
...
index 6bf7a03efc1..653997db4cc 100644
...
@@ -97,6 +111,10 @@ class Mage_Dataflow_Model_Profile extends Mage_Core_Model_Abstract
...
@@ -104,9 +122,58 @@ class Mage_Dataflow_Model_Profile extends Mage_Core_Model_Abstract
...
index abd3594bd9b..a446865e572 100644
...
index 2ca524a5b0d..7840d8c3db0 100644
--- app/code/core/Mage/Review/controllers/ProductController.php
+++ app/code/core/Mage/Review/controllers/ProductController.php
@@ -292,7 +292,17 @@ class Mage_Review_ProductController extends Mage_Core_Controller_Front_Action
...
index bd26d95d896..57f0becc9e8 100644
...
+        return $this->getItemAddToCartUrlCustom($item);
     ...
     /**
@@ -186,7 +186,7 @@ abstract class Mage_Wishlist_Block_Abstract extends Mage_Catalog_Block_Product_A
      */
     public function getAddToWishlistUrl($product)
     {
...
+        return $this->getAddToWishlistUrlCustom($product);
      ...
      /**
@@ -376,4 +376,49 @@ abstract class Mage_Wishlist_Block_Abstract extends Mage_Catalog_Block_Product_A
         }
...
index f0bac1cf759..c5bb5e338cb 100644
--- app/code/core/Mage/Wishlist/Helper/Data.php
+++ app/code/core/Mage/Wishlist/Helper/Data.php
@@ -226,9 +226,7 @@ class Mage_Wishlist_Helper_Data extends Mage_Core_Helper_Abstract
      */
...
+        return $this->getRemoveUrlCustom($item);
     ...
     /**
@@ -288,20 +286,7 @@ class Mage_Wishlist_Helper_Data extends Mage_Core_Helper_Abstract
      */
...
+        return $this->getAddUrlWithCustomParams($item, $params);
     ...
     /**
@@ -312,18 +297,7 @@ class Mage_Wishlist_Helper_Data extends Mage_Core_Helper_Abstract
      */
...
+        return $this->getAddToCartUrlCustom($item);
     ...
     /**
@@ -443,4 +417,78 @@ class Mage_Wishlist_Helper_Data extends Mage_Core_Helper_Abstract
...
index e6a4be90b71..7bdc442b4e9 100644
...
index ec06af6a7ef..273f7023ac4 100644
...
index 6fdc3c05388..0e7f7e12d0b 100644
...
index 11030c054b6..dc856f3af94 100644
...
index 1de330594b5..d57e75825ee 100644
...
index f461a7e767b..309909e9940 100644
...
index b8b48f3fd9a..cbbd747ba4f 100644
--- js/varien/js.js
+++ js/varien/js.js
@@ -622,3 +622,19 @@ function customFormSubmit(url, parametersArray, method) {
...
index 6a9fcbfbd74..deb2812d00b 100644
