...
@@ -331,8 +345,8 @@ class Mage_Checkout_CartController extends Mage_Core_Controller_Front_Action
...
+                    $message = $this->__('%s was updated in your shopping cart.', Mage::helper('core')->escapeHtml($item->getProduct()->getName()));
                 ...
                 $this->_goBack();
@@ -366,6 +380,10 @@ class Mage_Checkout_CartController extends Mage_Core_Controller_Front_Action
      */
...
@@ -441,6 +459,11 @@ class Mage_Checkout_CartController extends Mage_Core_Controller_Front_Action
         $this->_goBack();
     }
...
@@ -437,15 +467,21 @@ class Mage_Checkout_OnepageController extends Mage_Checkout_Controller_Action
      */
...
@@ -462,7 +498,7 @@ class Mage_Checkout_OnepageController extends Mage_Checkout_Controller_Action
             $result['error']   = false;
...
@@ -477,12 +513,13 @@ class Mage_Checkout_OnepageController extends Mage_Checkout_Controller_Action
             $result['error'] = true;
...
+        );
     ...
     /**
@@ -296,33 +298,35 @@ class Mage_Wishlist_Helper_Data extends Mage_Core_Helper_Abstract
...
@@ -443,4 +447,27 @@ class Mage_Wishlist_Helper_Data extends Mage_Core_Helper_Abstract
