...
SUPEE-10975_CE_v1.5.0.0 | CE_1.5.0.0 | v1 | ef6f65a90e225688f981d04214df207508356050 | Tue Nov 27 02:26:47 2018 +0200 | ce-1.5.0.0-dev
...
index c0a3cdd536c..d0498838033 100644
...
index e4b3df986fb..cda43dee918 100644
...
@@ -276,6 +278,13 @@ class Mage_Cms_Model_Wysiwyg_Images_Storage extends Varien_Object
         }
         $uploader->setAllowRenameFiles(true);
...
+        }
         ...
         if (!$result) {
@@ -373,7 +382,9 @@ class Mage_Cms_Model_Wysiwyg_Images_Storage extends Varien_Object
...
index 0103fe475a8..e912a879267 100644
--- app/code/core/Mage/Core/Model/File/Validator/Image.php
+++ app/code/core/Mage/Core/Model/File/Validator/Image.php
@@ -87,13 +87,55 @@ class Mage_Core_Model_File_Validator_Image
      */
...
@@ -108,5 +150,4 @@ class Mage_Core_Model_File_Validator_Image
     {
...
index f57fd968425..edacfc93b89 100644
...
index 4f24efb1bd8..19ac2081573 100644
--- app/code/core/Mage/Wishlist/controllers/IndexController.php
+++ app/code/core/Mage/Wishlist/controllers/IndexController.php
@@ -474,6 +474,9 @@ class Mage_Wishlist_IndexController extends Mage_Wishlist_Controller_Abstract
         if (empty($emails)) {
...
index 3a51b8a5e0a..0ccebfef93e 100644
