...
SUPEE-10415-ce-1.9.3.0 | CE_1.9.3.0 | v1 | d87527610c585fb9bf63dab8c495d0fb0cdb37dc | Thu Nov 9 11:25:30 2017 +0200 | 2707a494baf8413dca12b8094e157f58198eedfb..HEAD

__PATCHFILE_FOLLOWS__
diff --git app/Mage.php app/Mage.php
index ca15775..be0ef50 100644
--- app/Mage.php
+++ app/Mage.php
...
+    /**
      ...
      *
      * @var string
@@ -873,6 +878,10 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
...
@@ -899,7 +908,7 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
     }
...
@@ -913,6 +922,10 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
             $errors[] = Mage::helper('customer')
                 ->__('The minimum password length is %s', self::MINIMUM_PASSWORD_LENGTH);
         }
