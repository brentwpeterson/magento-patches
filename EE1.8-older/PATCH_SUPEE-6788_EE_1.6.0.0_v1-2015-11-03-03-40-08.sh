...
SUPEE-6788 | EE_1.6.0.0 | v1 | f26809476bcaa08bf6d0636371642678732fda1b | Thu Oct 29 14:59:33 2015 +0200 | ca6d4ec5556748f05862256da614e2a9f6b2643f..f26809476bcaa08bf6d0636371642678732fda1b
...
index f54afe7..d9786eb 100644
--- app/code/core/Mage/Core/Helper/Abstract.php
+++ app/code/core/Mage/Core/Helper/Abstract.php
@@ -211,6 +211,17 @@ abstract class Mage_Core_Helper_Abstract
     }
...
index 4ba6d51..e042c27 100644
--- app/code/core/Mage/Core/Model/Email/Template/Filter.php
+++ app/code/core/Mage/Core/Model/Email/Template/Filter.php
@@ -61,6 +61,12 @@ class Mage_Core_Model_Email_Template_Filter extends Varien_Filter_Template
      */
...
+
      ...
      *
@@ -68,6 +74,8 @@ class Mage_Core_Model_Email_Template_Filter extends Varien_Filter_Template
     public function __construct()
     {
...
+        $this->_permissionBlock = Mage::getModel('admin/block');
     ...
     /**
@@ -107,8 +115,10 @@ class Mage_Core_Model_Email_Template_Filter extends Varien_Filter_Template
...
index c73dba6..3331640 100644
--- app/code/core/Mage/Core/Model/Resource/Setup.php
+++ app/code/core/Mage/Core/Model/Resource/Setup.php
@@ -295,7 +295,6 @@ class Mage_Core_Model_Resource_Setup
                     }
                 }
                 catch (Exception $e){
...
index 2a13e3f..274ebe9 100644
--- app/code/core/Mage/Customer/controllers/AccountController.php
+++ app/code/core/Mage/Customer/controllers/AccountController.php
@@ -234,12 +234,17 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
      */
...
@@ -305,7 +310,7 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
@@ -318,10 +323,9 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
+
     ...
     <adminhtml_permissions_role_index>
         <reference name="content">
diff --git app/design/frontend/enterprise/blank/template/customer/form/register.phtml app/design/frontend/enterprise/blank/template/customer/form/register.phtml
index f694d18..bd1147c 100644
--- app/design/frontend/enterprise/blank/template/customer/form/register.phtml
+++ app/design/frontend/enterprise/blank/template/customer/form/register.phtml
@@ -40,6 +40,7 @@
         <fieldset>
...
index c7ee9e3..7764eaa 100644
--- lib/Varien/Data/Collection/Db.php
+++ lib/Varien/Data/Collection/Db.php
@@ -306,8 +306,14 @@ class Varien_Data_Collection_Db extends Varien_Data_Collection
      */
...
@@ -355,7 +361,7 @@ class Varien_Data_Collection_Db extends Varien_Data_Collection
