...
SUPEE-6285 | EE_1.8.0.0 | v1 | 5a6627b92b771ff54de6a86e1cfb78aac1737ae2 | Thu Jul 9 18:15:18 2015 +0300 | v1.8.0.0..HEAD

__PATCHFILE_FOLLOWS__
diff --git app/Mage.php app/Mage.php
index 81c1ef4..c511d60 100644
--- app/Mage.php
+++ app/Mage.php
...
index 19e509f..08e0255 100644
--- app/code/core/Enterprise/Banner/controllers/Adminhtml/Banner/WidgetController.php
+++ app/code/core/Enterprise/Banner/controllers/Adminhtml/Banner/WidgetController.php
@@ -47,4 +47,14 @@ class Enterprise_Banner_Adminhtml_Banner_WidgetController extends Enterprise_Ent
...
index e999944..295dc31 100644
--- app/code/core/Enterprise/Cms/controllers/Adminhtml/Cms/Hierarchy/WidgetController.php
+++ app/code/core/Enterprise/Cms/controllers/Adminhtml/Cms/Hierarchy/WidgetController.php
@@ -52,4 +52,14 @@ class Enterprise_Cms_Adminhtml_Cms_Hierarchy_WidgetController extends Enterprise
...
index 84586e2..47883a8 100644
--- app/code/core/Enterprise/Cms/controllers/Adminhtml/Cms/PageController.php
+++ app/code/core/Enterprise/Cms/controllers/Adminhtml/Cms/PageController.php
@@ -183,8 +183,9 @@ class Enterprise_Cms_Adminhtml_Cms_PageController extends Enterprise_Enterprise_
      */
     protected function _isAllowed()
     {
-        switch ($this->getRequest()->getActionName()) {
...
index dd34624..b52d916 100644
--- app/code/core/Enterprise/Logging/controllers/Adminhtml/LoggingController.php
+++ app/code/core/Enterprise/Logging/controllers/Adminhtml/LoggingController.php
@@ -137,15 +137,16 @@ class Enterprise_Logging_Adminhtml_LoggingController extends Enterprise_Enterpri
      */
     protected function _isAllowed()
     {
-        switch ($this->getRequest()->getActionName()) {
...
index 5df02c7..fa93b25 100644
--- app/code/core/Enterprise/SalesArchive/controllers/Adminhtml/Sales/OrderController.php
+++ app/code/core/Enterprise/SalesArchive/controllers/Adminhtml/Sales/OrderController.php
@@ -40,7 +40,8 @@ class Enterprise_SalesArchive_Adminhtml_Sales_OrderController extends Enterprise
      */
     protected function _isAllowed()
     {
...
index 3863faa..b3ea971 100644
--- app/code/core/Mage/Core/Block/Abstract.php
+++ app/code/core/Mage/Core/Block/Abstract.php
@@ -934,6 +934,19 @@ abstract class Mage_Core_Block_Abstract extends Varien_Object
     }
...
index 01e6692..63b5b34 100644
--- app/code/core/Mage/Core/Helper/Abstract.php
+++ app/code/core/Mage/Core/Helper/Abstract.php
@@ -254,6 +254,22 @@ abstract class Mage_Core_Helper_Abstract
     }
