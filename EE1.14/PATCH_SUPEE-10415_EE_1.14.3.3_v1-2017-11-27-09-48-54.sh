...
SUPEE-10415-1.14.3.3 | EE_1.14.3.3 | v1 | 435e7b32860185496284ea210c8ed3ab10dbc823 | Tue Nov 7 15:06:16 2017 +0200 | b378231add635acec672d83a9b091e2805127b53..HEAD

__PATCHFILE_FOLLOWS__
diff --git app/Mage.php app/Mage.php
index 9cfb45e..b0db799 100644
--- app/Mage.php
+++ app/Mage.php
...
+    /**
      ...
      *
      * @var string
@@ -872,10 +877,20 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
...
@@ -902,7 +917,7 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
     }
...
@@ -916,6 +931,10 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
             $errors[] = Mage::helper('customer')
                 ->__('The minimum password length is %s', self::MINIMUM_PASSWORD_LENGTH);
         }
...
index 5ddc342..90b417a 100644
--- app/design/frontend/enterprise/default/template/giftcardaccount/onepage/payment/scripts.phtml
+++ app/design/frontend/enterprise/default/template/giftcardaccount/onepage/payment/scripts.phtml
@@ -32,10 +32,12 @@ function enablePaymentMethods(free) {
