...
SUPEE-10415-1.14.3.0 | EE_1.14.3.0 | v1 | 1b903e87b0a0996e537abbf38f0ce20b397a8cf2 | Tue Nov 7 15:23:53 2017 +0200 | 8765bb6038df1e6f7b834f4469744caed0ead9ef..HEAD

__PATCHFILE_FOLLOWS__
diff --git app/Mage.php app/Mage.php
index eb406a8..be09260 100644
--- app/Mage.php
+++ app/Mage.php
...
+    /**
      ...
      *
      * @var string
@@ -869,10 +874,20 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
...
@@ -899,7 +914,7 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
     }
...
@@ -913,6 +928,10 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
             $errors[] = Mage::helper('customer')
                 ->__('The minimum password length is %s', self::MINIMUM_PASSWORD_LENGTH);
         }
