...
PATCH_SUPEE-9767_EE_1.14.3.2_v2 | EE_1.14.3.2 | v2 | 6566db274beaeb9bcdb56a62e02cc2da532e618c | Thu Jun 22 04:30:03 2017 +0300 | v1.14.3.3..HEAD
...
index 7d761ba..d475475 100644
--- app/code/core/Enterprise/PageCache/Model/Observer.php
+++ app/code/core/Enterprise/PageCache/Model/Observer.php
@@ -263,11 +263,11 @@ class Enterprise_PageCache_Model_Observer
...
@@ -711,7 +711,7 @@ class Enterprise_PageCache_Model_Observer
...
index 516d117..24758f7 100644
--- app/code/core/Enterprise/PageCache/Model/Processor.php
+++ app/code/core/Enterprise/PageCache/Model/Processor.php
@@ -419,10 +419,9 @@ class Enterprise_PageCache_Model_Processor
             $isProcessed = false;
         }
...
index d927dcd..2d50db3 100644
--- app/code/core/Mage/Checkout/controllers/OnepageController.php
+++ app/code/core/Mage/Checkout/controllers/OnepageController.php
@@ -349,6 +349,7 @@ class Mage_Checkout_OnepageController extends Mage_Checkout_Controller_Action
         if ($this->_expireAjax()) {
             return;
         }
+
...
@@ -364,6 +365,11 @@ class Mage_Checkout_OnepageController extends Mage_Checkout_Controller_Action
         if ($this->_expireAjax()) {
             return;
         }
+
...
@@ -406,6 +412,11 @@ class Mage_Checkout_OnepageController extends Mage_Checkout_Controller_Action
         if ($this->_expireAjax()) {
             return;
         }
+
...
@@ -430,6 +441,11 @@ class Mage_Checkout_OnepageController extends Mage_Checkout_Controller_Action
         if ($this->_expireAjax()) {
             return;
         }
+
...
@@ -464,6 +480,11 @@ class Mage_Checkout_OnepageController extends Mage_Checkout_Controller_Action
         if ($this->_expireAjax()) {
             return;
         }
+
...
index 06fa6b1..04d722d 100644
--- app/code/core/Mage/Core/Model/File/Validator/Image.php
+++ app/code/core/Mage/Core/Model/File/Validator/Image.php
@@ -88,10 +88,51 @@ class Mage_Core_Model_File_Validator_Image
      */
...
@@ -106,5 +147,4 @@ class Mage_Core_Model_File_Validator_Image
     {
...
index 44c5ed9..b7b3915 100644
--- app/design/frontend/enterprise/default/template/checkout/cart/shipping.phtml
+++ app/design/frontend/enterprise/default/template/checkout/cart/shipping.phtml
@@ -103,6 +103,7 @@
         <div class="buttons-set">
             <button type="submit" class="button" name="do" value="<?php echo Mage::helper('core')->quoteEscape($this->__('Update Total')) ?>"><span><span><?php echo $this->__('Update Total') ?></span></span></button>
         </div>
+        <?php echo $this->getBlockHtml('formkey') ?>
     </fieldset>
 </form>
...
@@ -81,5 +81,6 @@
         ...
         <button type="submit" data-action="checkout-continue-shipping" class="button<?php if ($this->isContinueDisabled()):?> disabled<?php endif; ?>" onclick="$('can_continue_flag').value=1"<?php if ($this->isContinueDisabled()):?> disabled="disabled"<?php endif; ?>><span><span><?php echo $this->__('Continue to Shipping Information') ?></span></span></button>
     </div>
+    <?php echo $this->getBlockHtml('formkey') ?>
 </fieldset>
 </form>
...
index dad8ac8..05c2e52 100644
--- app/design/frontend/enterprise/default/template/checkout/multishipping/billing.phtml
+++ app/design/frontend/enterprise/default/template/checkout/multishipping/billing.phtml
@@ -92,6 +92,7 @@
     <p class="back-link"><a href="<?php echo $this->getBackUrl() ?>"><small>&laquo; </small><?php echo $this->__('Back to Shipping Information') ?></a></p>
     <button id="payment-continue" type="submit" class="button"><span><span><?php echo $this->__('Continue to Review Your Order') ?></span></span></button>
 </div>
+<?php echo $this->getBlockHtml('formkey') ?>
 </form>
 </div>
...
+    <?php echo $this->getBlockHtml('formkey') ?>
 ...
 <script type="text/javascript">
diff --git app/design/frontend/rwd/enterprise/layout/page.xml app/design/frontend/rwd/enterprise/layout/page.xml
index c8d0d7d..a451139 100644
--- app/design/frontend/rwd/enterprise/layout/page.xml
+++ app/design/frontend/rwd/enterprise/layout/page.xml
@@ -36,7 +36,7 @@
...
+    <?php echo $this->getBlockHtml('formkey') ?>
 ...
 <script type="text/javascript">
diff --git app/design/frontend/rwd/enterprise/template/checkout/onepage/shipping.phtml app/design/frontend/rwd/enterprise/template/checkout/onepage/shipping.phtml
index 0b72e02..5f33b9a 100644
--- app/design/frontend/rwd/enterprise/template/checkout/onepage/shipping.phtml
+++ app/design/frontend/rwd/enterprise/template/checkout/onepage/shipping.phtml
@@ -148,6 +148,7 @@
             <img src="<?php echo $this->getSkinUrl('images/opc-ajax-loader.gif') ?>" alt="<?php echo Mage::helper('core')->quoteEscape($this->__('Loading next step...')) ?>" title="<?php echo Mage::helper('core')->quoteEscape($this->__('Loading next step...')) ?>" class="v-middle" /> <?php echo $this->__('Loading next step...') ?>
         </span>
...
+    <?php echo $this->getBlockHtml('formkey') ?>
 ...
 <script type="text/javascript">
 //<![CDATA[
diff --git app/design/frontend/rwd/enterprise/template/customerbalance/checkout/onepage/payment/additional.phtml app/design/frontend/rwd/enterprise/template/customerbalance/checkout/onepage/payment/additional.phtml
index 1802832..699aacf 100644
--- app/design/frontend/rwd/enterprise/template/customerbalance/checkout/onepage/payment/additional.phtml
+++ app/design/frontend/rwd/enterprise/template/customerbalance/checkout/onepage/payment/additional.phtml
@@ -118,7 +118,7 @@
         } else {
             var elements = Form.getElements(this.form);
...
diff --git app/design/frontend/rwd/enterprise/template/giftcardaccount/multishipping/payment.phtml app/design/frontend/rwd/enterprise/template/giftcardaccount/multishipping/payment.phtml
index 08caf8a..5b135cf 100644
--- app/design/frontend/rwd/enterprise/template/giftcardaccount/multishipping/payment.phtml
+++ app/design/frontend/rwd/enterprise/template/giftcardaccount/multishipping/payment.phtml
@@ -38,7 +38,7 @@
         <script type="text/javascript">
         //<![CDATA[
...
+                || elements[i].name == 'form_key'
                 ...
                 methodName = elements[i].value;
                 if ((free && methodName == 'free') || (!free && methodName != 'free')) {
diff --git app/design/frontend/rwd/enterprise/template/invitation/form.phtml app/design/frontend/rwd/enterprise/template/invitation/form.phtml
index 23d4e96..3122c41 100644
--- app/design/frontend/rwd/enterprise/template/invitation/form.phtml
+++ app/design/frontend/rwd/enterprise/template/invitation/form.phtml
@@ -36,6 +36,7 @@
 <?php echo $this->getChildHtml('form_before')?>
 <?php if ($maxPerSend = (int)Mage::helper('enterprise_invitation')->getMaxInvitationsPerSend()): ?>
...
+    <?php echo $this->getBlockHtml('formkey') ?>
 ...
 <script type="text/javascript">
diff --git app/design/frontend/rwd/enterprise/template/reward/checkout/onepage/payment/additional.phtml app/design/frontend/rwd/enterprise/template/reward/checkout/onepage/payment/additional.phtml
index 21330ef..e089405 100644
--- app/design/frontend/rwd/enterprise/template/reward/checkout/onepage/payment/additional.phtml
+++ app/design/frontend/rwd/enterprise/template/reward/checkout/onepage/payment/additional.phtml
@@ -94,7 +94,7 @@
...
diff --git dev/tests/functional/tests/app/Mage/Admin/Test/Constraint/AssertUserAccessDeniedMessage.php dev/tests/functional/tests/app/Mage/Admin/Test/Constraint/AssertUserAccessDeniedMessage.php
index 80dac75..e094556 100644
--- dev/tests/functional/tests/app/Mage/Admin/Test/Constraint/AssertUserAccessDeniedMessage.php
+++ dev/tests/functional/tests/app/Mage/Admin/Test/Constraint/AssertUserAccessDeniedMessage.php
...
diff --git dev/tests/functional/tests/app/Mage/Admin/Test/Constraint/AssertUserAccountInactiveMessage.php dev/tests/functional/tests/app/Mage/Admin/Test/Constraint/AssertUserAccountInactiveMessage.php
index c965b5b..ecf65ba 100644
--- dev/tests/functional/tests/app/Mage/Admin/Test/Constraint/AssertUserAccountInactiveMessage.php
+++ dev/tests/functional/tests/app/Mage/Admin/Test/Constraint/AssertUserAccountInactiveMessage.php
...
diff --git dev/tests/functional/tests/app/Mage/Admin/Test/Constraint/AssertUserWrongCredentialsMessage.php dev/tests/functional/tests/app/Mage/Admin/Test/Constraint/AssertUserWrongCredentialsMessage.php
index bd26529..b35acbb 100644
--- dev/tests/functional/tests/app/Mage/Admin/Test/Constraint/AssertUserWrongCredentialsMessage.php
+++ dev/tests/functional/tests/app/Mage/Admin/Test/Constraint/AssertUserWrongCredentialsMessage.php
...
diff --git dev/tests/integration/testsuite/Mage/Core/Controller/RequestHttpTest.php dev/tests/integration/testsuite/Mage/Core/Controller/RequestHttpTest.php
new file mode 100644
index 0000000..0bfe896
--- /dev/null
+++ dev/tests/integration/testsuite/Mage/Core/Controller/RequestHttpTest.php
@@ -0,0 +1,180 @@
+<?php
+/**
+ * {license_notice}
...
+
+    /**
+     * @covers Mage_Core_Controller_Request_Http::setPathInfo
+     * @covers Mage_Core_Controller_Request_Http::getPathInfo
+     * @dataProvider setGetPathInfoDataProvider
+     */
+    public function testSetGetPathInfo($requestUri, $expectedPathInfo)
+    {
...
+        $this->_model->setPathInfo();
+        $this->assertEquals($expectedPathInfo, $this->_model->getPathInfo());
+
...
+        return array(
+            array('/test', '/test'),
+            array('/index.php/test', '/test'),
+            array('/index.phptest', ''),
+            array('/index.phptest/test', ''),
+            array('/index.php', ''),
+        );
+    }
+
...
+
+}
diff --git dev/tests/integration/testsuite/Mage/Dataflow/Model/Convert/Container/AbstractTest.php dev/tests/integration/testsuite/Mage/Dataflow/Model/Convert/Container/AbstractTest.php
new file mode 100644
index 0000000..8f35ca5
--- /dev/null
+++ dev/tests/integration/testsuite/Mage/Dataflow/Model/Convert/Container/AbstractTest.php
@@ -0,0 +1,80 @@
+<?php
+/**
+ * {license_notice}
...
+
+/**
+ * Class Mage_Dataflow_Model_Convert_Container_AbstractTest
+ *
+ * @group module:Mage_Dataflow
+ */
+class Mage_Dataflow_Model_Convert_Container_AbstractTest extends PHPUnit_Framework_TestCase
+{
...
+     * @var string
+     */
+    protected $className = 'Mage_Dataflow_Model_Convert_Container_Abstract';
+
+    /**
+     * Setup
+     */
+    public function setUp()
+    {
+        $this->modelMock = $this->getMockForAbstractClass($this->className);
+    }
+
+    /**
+     * Tear down
...
+
+    /**
+     * Test for setData, validateDataSerialized and isSerialized
+     *
+     * @param string $data
+     * @param string $expected
+     *
+     * @dataProvider testSetDataDataProvider
+     * @covers Mage_Dataflow_Model_Convert_Container_Abstract::setData
+     * @covers Mage_Dataflow_Model_Convert_Container_Abstract::validateDataSerialized
+     * @covers Mage_Dataflow_Model_Convert_Container_Abstract::isSerialized
+     */
+    public function testSetData($data, $expected)
+    {
+        $this->modelMock->setData($data);
+        $this->assertEquals($expected, $this->modelMock->getData());
+    }
+
+    /**
...
+     * @return array
+     */
+    public function testSetDataDataProvider()
+    {
+        $array = array('string' => 'Test string');
+        $object = new Varien_Object();
+
+        $serializedArray           = serialize($array);
+        $serializedObject          = serialize($object);
+        $serializedArrayWithObject = serialize($array['object'] = $object);
+
+        return array(
+            array('Test string', 'Test string'),
+            array($serializedArray, $serializedArray),
+            array($serializedObject, null),
+            array($serializedArrayWithObject, null),
+        );
+    }
+}
diff --git dev/tests/integration/testsuite/Mage/Sales/Model/Quote/ItemTest.php dev/tests/integration/testsuite/Mage/Sales/Model/Quote/ItemTest.php
new file mode 100644
index 0000000..9dff4d6
--- /dev/null
+++ dev/tests/integration/testsuite/Mage/Sales/Model/Quote/ItemTest.php
@@ -0,0 +1,207 @@
+<?php
+/**
+ * {license_notice}
...
+     */
+    public function testCompare ($testData, $expected)
+    {
+        $_itemToCompare = $this->getMock(
+            'Mage_Sales_Model_Quote_Item',
+            array(
+                'getOptionByCode',
+                'getProductId',
...
+        );
+
+        $_product = $this->getMock('Mage_Catalog_Model_Product', array('hasCustomOptions'), array(), '', false);
+        $_product->expects($this->any())
+            ->method('hasCustomOptions')
+            ->will($this->returnValue($testData['custom_options']));
+
+        $this->_model->expects($this->any())
+            ->method('getOptions')
+            ->will($this->returnValue($testData['options']));
+        $this->_model->expects($this->once())
+            ->method('getProductId')
+            ->will($this->returnValue($testData['item_product_id']));
+
+        $_itemToCompare->expects($this->any())
+            ->method('getOptionByCode')
+            ->will($this->returnValue($testData['item_option']));
+        $_itemToCompare->expects($this->once())
+            ->method('getProductId')
+            ->will($this->returnValue($testData['compare_product_id']));
+        $_itemToCompare->expects($this->any())
+            ->method('getProduct')
+            ->will($this->returnValue($_product));
+
+        $this->assertEquals($expected, $this->_model->compare($_itemToCompare));
+    }
+
+    /**
+     * DataProvider method for testCompare
+     */
...
+                array(
+                    'item_product_id' => 1,
+                    'compare_product_id' => 1,
+                    'options' => array(new Varien_Object(array('code' => 'some_code', 'value' => 1))),
+                    'item_option' => new Varien_Object(array('value' => 1)),
+                    'custom_options' => null,
+                ),
+                true,
+            ),
...
+                    'item_product_id' => 1,
+                    'compare_product_id' => 1,
+                    'options' => array(new Varien_Object(array('code' => 'info_buyRequest', 'value' => 1))),
+                    'item_option' => new Varien_Object(array('value' => 1)),
+                    'custom_options' => array('some_option' => 1),
+                ),
+                true,
+            ),
+            array(
...
+                    'item_product_id' => 1,
+                    'compare_product_id' => 1,
+                    'options' => array(new Varien_Object(array('code' => 'some_code', 'value' => 2))),
+                    'item_option' => new Varien_Object(array('value' => 1)),
+                    'custom_options' => array('some_option' => 1),
+                ),
+                false,
...
+                    'item_product_id' => 1,
+                    'compare_product_id' => 1,
+                    'options' => array(new Varien_Object(array('code' => 'some_code', 'value' => $serializedValue))),
+                    'item_option' => new Varien_Object(array('value' => $serializedValue)),
+                    'custom_options' => null,
+                ),
+                true,
+            ),
