...
SUPEE-8788 | EE_1.14.2.0 | v1 | f9b762da5337f37b1d1ecfa9ae7f15b99b1e0fa8 | Mon Sep 26 10:40:17 2016 +0300 | b3f3166455..f9b762da53
...
index 87b773a..b838b8e 100644
--- app/code/core/Enterprise/PageCache/Model/Processor.php
+++ app/code/core/Enterprise/PageCache/Model/Processor.php
@@ -729,7 +729,13 @@ class Enterprise_PageCache_Model_Processor
          * Define request URI
          */
         if ($uri) {
...
+    }
+}
diff --git oauth_test.php oauth_test.php
new file mode 100644
index 0000000..9cd9dc4
--- /dev/null
+++ oauth_test.php
@@ -0,0 +1,62 @@
+<?php
+/**
+ * Copyright Magento 2016
+ * Example of products list retrieve using Customer account via Magento
+REST API. OAuth authorization is used
+ */
+
+$testScriptHost = "http://local.loc/ee-1-14-20/";
+$magentoHost = "http://local.loc/ee-1-14-20/";
+$callbackUrl = $testScriptHost . "oauth_test.php";
+$consumerKey = '72f7fb5555fc0666040512a4aa702f09';
+$consumerSecret = '13be6055362797fdd02d2dd4e44e5352';
+
+$temporaryCredentialsRequestUrl =
+    $magentoHost . "oauth/initiate?oauth_callback=" .
+    urlencode($callbackUrl);
+
+$adminAuthorizationUrl = $magentoHost . 'admin/oAuth_authorize';
...
+}
+try {
+    $authType = (isset($_SESSION['state']) && $_SESSION['state'] == 2) ? OAUTH_AUTH_TYPE_AUTHORIZATION
+        : OAUTH_AUTH_TYPE_URI;
