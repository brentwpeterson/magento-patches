...
PATCH_SUPEE-9767_EE_1.14.3.0_v2 | EE_1.14.3.0 | v2 | 6566db274beaeb9bcdb56a62e02cc2da532e618c | Thu Jun 22 04:30:03 2017 +0300 | v1.14.3.3..HEAD
...
+        return $this;
     ...
     /**
@@ -793,6 +793,7 @@ class Enterprise_PageCache_Model_Observer
...
@@ -815,6 +816,7 @@ class Enterprise_PageCache_Model_Observer
...
@@ -1088,11 +1090,9 @@ class Enterprise_PageCache_Model_Observer
             return;
         }
...
@@ -1207,4 +1207,12 @@ class Enterprise_PageCache_Model_Observer
         }
...
index 7fbbd27..dfa739a73 100644
