...
PATCH_SUPEE-9767_EE_1.14.0.1_v2 | EE_1.14.0.1 | v2 | 6566db274beaeb9bcdb56a62e02cc2da532e618c | Thu Jun 22 04:30:03 2017 +0300 | v1.14.3.3..HEAD
...
index e0f85d8..2bc2f5b 100755
--- app/code/core/Enterprise/PageCache/Model/Observer.php
+++ app/code/core/Enterprise/PageCache/Model/Observer.php
@@ -484,7 +484,7 @@ class Enterprise_PageCache_Model_Observer
...
+        return $this;
     ...
     /**
@@ -549,6 +549,7 @@ class Enterprise_PageCache_Model_Observer
...
@@ -571,6 +572,7 @@ class Enterprise_PageCache_Model_Observer
...
@@ -827,11 +829,9 @@ class Enterprise_PageCache_Model_Observer
             return;
         }
...
@@ -929,4 +929,12 @@ class Enterprise_PageCache_Model_Observer
         );
         return $this;
     }
+
...
index 124a01b..0f73b47 100644
--- app/code/core/Enterprise/PageCache/Model/Processor.php
+++ app/code/core/Enterprise/PageCache/Model/Processor.php
@@ -396,11 +396,9 @@ class Enterprise_PageCache_Model_Processor
             $isProcessed = false;
         }
