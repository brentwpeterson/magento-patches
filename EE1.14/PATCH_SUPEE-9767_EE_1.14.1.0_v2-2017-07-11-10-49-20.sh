...
PATCH_SUPEE-9767_EE_1.14.1.0_v2 | EE_1.14.1.0 | v2 | 6566db274beaeb9bcdb56a62e02cc2da532e618c | Thu Jun 22 04:30:03 2017 +0300 | v1.14.3.3..HEAD
...
index b2ab56c..12cd364 100755
--- app/code/core/Enterprise/PageCache/Model/Observer.php
+++ app/code/core/Enterprise/PageCache/Model/Observer.php
@@ -581,7 +581,7 @@ class Enterprise_PageCache_Model_Observer
...
+        return $this;
     ...
     /**
@@ -663,6 +663,7 @@ class Enterprise_PageCache_Model_Observer
...
@@ -685,6 +686,7 @@ class Enterprise_PageCache_Model_Observer
...
@@ -958,11 +960,9 @@ class Enterprise_PageCache_Model_Observer
             return;
         }
...
@@ -1060,4 +1060,12 @@ class Enterprise_PageCache_Model_Observer
         );
         return $this;
     }
+
...
index 0ac680e..19e86a1 100644
--- app/code/core/Enterprise/PageCache/Model/Processor.php
+++ app/code/core/Enterprise/PageCache/Model/Processor.php
@@ -415,11 +415,9 @@ class Enterprise_PageCache_Model_Processor
             $isProcessed = false;
         }
