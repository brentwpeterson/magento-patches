...
PATCH_SUPEE-9767_EE_1.14.1.0_v1.sh | EE_1.14.1.0 | v1 | 226caf7 | Mon Feb 20 17:33:39 2017 +0200 | 2321b14
...
index baadb59..54adc23 100644
--- app/code/community/OnTap/Merchandiser/Model/Resource/Merchandiser.php
+++ app/code/community/OnTap/Merchandiser/Model/Resource/Merchandiser.php
@@ -139,7 +139,10 @@ class OnTap_Merchandiser_Model_Resource_Merchandiser extends Mage_Catalog_Model_
     {
...
@@ -161,7 +174,7 @@ class Enterprise_PageCache_Model_Observer
...
@@ -172,7 +185,7 @@ class Enterprise_PageCache_Model_Observer
...
@@ -228,7 +241,7 @@ class Enterprise_PageCache_Model_Observer
...
@@ -244,7 +257,7 @@ class Enterprise_PageCache_Model_Observer
...
+        $this->unregisterContext($block);
         ...
         if (empty($tags)) {
@@ -301,12 +329,59 @@ class Enterprise_PageCache_Model_Observer
         if (empty($tags)) {
             return $this;
         }
...
+    /**
      ...
      *
      * @param Varien_Event_Observer $observer
@@ -482,7 +557,10 @@ class Enterprise_PageCache_Model_Observer
...
@@ -663,6 +741,7 @@ class Enterprise_PageCache_Model_Observer
...
@@ -685,6 +764,7 @@ class Enterprise_PageCache_Model_Observer
...
@@ -961,8 +1041,8 @@ class Enterprise_PageCache_Model_Observer
...
@@ -1060,4 +1140,29 @@ class Enterprise_PageCache_Model_Observer
         );
         return $this;
     }
+
...
+    /**
      ...
      *
      * @var string
@@ -159,4 +164,36 @@ class Mage_Core_Controller_Front_Action extends Mage_Core_Controller_Varien_Acti
         }
         return $this;
     }
+
