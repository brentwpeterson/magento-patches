...
SUPEE-8788 | EE_1.11.0.2 | v2 | 2943b579428292d85aa81fca627f251277d8bd3d | Fri Oct 14 17:35:14 2016 +0300 | a3dfcc997de54abd6ff2f2466c419d15deb4d9b0
...
+
      ...
      */
@@ -181,4 +183,24 @@ class Enterprise_PageCache_Model_Cookie extends Mage_Core_Model_Cookie
     {
...
index fa27555..09d6f8a 100644
--- app/code/core/Enterprise/PageCache/Model/Observer.php
+++ app/code/core/Enterprise/PageCache/Model/Observer.php
@@ -535,4 +535,23 @@ class Enterprise_PageCache_Model_Observer
...
index f64fad0..f707ff7 100644
--- app/code/core/Enterprise/PageCache/Model/Processor.php
+++ app/code/core/Enterprise/PageCache/Model/Processor.php
@@ -371,6 +371,15 @@ class Enterprise_PageCache_Model_Processor
             $isProcessed = false;
         }
...
+
          ...
          */
@@ -453,6 +462,7 @@ class Enterprise_PageCache_Model_Processor
                  * Replace all occurrences of session_id with unique marker
                  */
                 Enterprise_PageCache_Helper_Url::replaceSid($content);
+                Enterprise_PageCache_Helper_Form_Key::replaceFormKey($content);
...
@@ -622,7 +632,13 @@ class Enterprise_PageCache_Model_Processor
          * Define request URI
          */
         if ($uri) {
...
@@ -1172,7 +1176,13 @@ abstract class Mage_Core_Block_Abstract extends Varien_Object
...
@@ -120,4 +132,16 @@ class Mage_Core_Helper_Url extends Mage_Core_Helper_Abstract
...
+    background:url(images/blank.gif) repeat;
     ...
     color:#d85909;
     font-size:1.1em;
@@ -1259,8 +1259,6 @@ ul.super-product-attributes { padding-left:15px; }
