...
SUPEE-10752_EE_v1.11.0.2 | EE_1.11.0.2 | v1 | f5f07b4fa2d40e0d02071e7d15d1fec6110cef77 | Tue Jun 5 01:00:14 2018 +0300 | ee-1.11.0.2-dev
...
index 839d9a89f82..c950cfd92ce 100644
--- app/code/core/Enterprise/TargetRule/Model/Rule.php
+++ app/code/core/Enterprise/TargetRule/Model/Rule.php
@@ -313,8 +313,13 @@ class Enterprise_TargetRule_Model_Rule extends Mage_Rule_Model_Rule
...
index 62920b8c778..03a78ed3fbd 100644
--- app/code/core/Mage/Admin/Model/User.php
+++ app/code/core/Mage/Admin/Model/User.php
@@ -107,6 +107,10 @@ class Mage_Admin_Model_User extends Mage_Core_Model_Abstract
...
@@ -120,6 +124,14 @@ class Mage_Admin_Model_User extends Mage_Core_Model_Abstract
...
+
      ...
      *
@@ -305,8 +317,15 @@ class Mage_Admin_Model_User extends Mage_Core_Model_Abstract
...
index 12ffe612a8f..97f20f258df 100644
...
index 924168d328d..0c46b033782 100644
--- app/code/core/Mage/Catalog/Model/Product.php
+++ app/code/core/Mage/Catalog/Model/Product.php
@@ -456,6 +456,8 @@ class Mage_Catalog_Model_Product extends Mage_Catalog_Model_Abstract
...
+     * @throws Mage_Core_Exception
     ...
     {
@@ -481,6 +483,12 @@ class Mage_Catalog_Model_Product extends Mage_Catalog_Model_Abstract
...
index e5fa038a2f2..1a3e4e1473a 100644
...
index 731b30ff52c..6ff4c4bb8d5 100644
--- app/code/core/Mage/Checkout/Model/Type/Onepage.php
+++ app/code/core/Mage/Checkout/Model/Type/Onepage.php
@@ -678,6 +678,9 @@ class Mage_Checkout_Model_Type_Onepage
         Mage::helper('core')->copyFieldset('checkout_onepage_quote', 'to_customer', $quote, $customer);
         $customer->setPassword($customer->decryptPassword($quote->getPasswordHash()));
         $customer->setPasswordHash($customer->hashPassword($customer->getPassword()));
...
index 31b19fdab66..3db566eb2fe 100644
...
index 043660d4b89..e92b85b5641 100644
--- app/code/core/Mage/Customer/Helper/Data.php
+++ app/code/core/Mage/Customer/Helper/Data.php
@@ -300,6 +300,23 @@ class Mage_Customer_Helper_Data extends Mage_Core_Helper_Abstract
         );
     }
...
index 152a4b32fbf..9188e0f8943 100755
...
index 86f346af727..659d5dbda62 100644
...
@@ -579,6 +580,7 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
                 // activate customer
                 try {
...
@@ -822,6 +824,7 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
index f4f221ae247..a6eb646870c 100644
...
index 02562c8400f..4e9215f3fbb 100644
...
@@ -535,4 +535,14 @@ class Varien_Image_Adapter_Gd2 extends Varien_Image_Adapter_Abstract
