...
PATCH_SUPEE-9767_EE_1.11.0.2_v1.sh | EE_1.11.0.2 | v1 | 226caf7 | Mon Feb 20 17:33:39 2017 +0200 | 2321b14

__PATCHFILE_FOLLOWS__
diff --git app/Mage.php app/Mage.php
index 2a52fbc..f78716c 100644
--- app/Mage.php
+++ app/Mage.php
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -215,20 +264,35 @@ class Enterprise_PageCache_Model_Observer
             return $this;
         }
         $object = $observer->getEvent()->getObject();
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -240,6 +304,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -249,6 +314,7 @@ class Enterprise_PageCache_Model_Observer
...
@@ -262,6 +328,7 @@ class Enterprise_PageCache_Model_Observer
      *
      * @param Varien_Event_Observer $observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -280,6 +347,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -295,7 +363,7 @@ class Enterprise_PageCache_Model_Observer
...
@@ -304,6 +372,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -349,6 +418,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -360,18 +430,12 @@ class Enterprise_PageCache_Model_Observer
     }
...
-        // update customer viewed products index
         try {
             ...
             if ($productIds) {
@@ -392,16 +456,47 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -410,10 +505,13 @@ class Enterprise_PageCache_Model_Observer
         }
         $this->_getCookie()->updateCustomerCookies();
...
@@ -421,6 +519,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -444,9 +543,29 @@ class Enterprise_PageCache_Model_Observer
     }
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -464,6 +583,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -473,7 +593,7 @@ class Enterprise_PageCache_Model_Observer
...
@@ -481,6 +601,7 @@ class Enterprise_PageCache_Model_Observer
...
+     * @return Enterprise_PageCache_Model_Observer
     ...
     {
@@ -495,12 +616,14 @@ class Enterprise_PageCache_Model_Observer
...
@@ -537,6 +660,67 @@ class Enterprise_PageCache_Model_Observer
     }
...
+    /**
      ...
      *
      * @param Varien_Event_Observer $observer
@@ -550,8 +734,19 @@ class Enterprise_PageCache_Model_Observer
...
index 8c46796..29c31a1 100644
--- app/code/core/Mage/Adminhtml/Helper/Data.php
+++ app/code/core/Mage/Adminhtml/Helper/Data.php
@@ -35,6 +35,8 @@ class Mage_Adminhtml_Helper_Data extends Mage_Core_Helper_Abstract
 {
...
+     * Initializing layout messages by message storage(s), loading and adding messages to layout messages block
      ...
      * @param string|array $messagesStorage
      * @return Mage_Core_Controller_Varien_Action
@@ -667,8 +693,30 @@ abstract class Mage_Core_Controller_Varien_Action
      * @param   string $path
...
index 789bbc8..9c300ce 100644
--- app/code/core/Mage/Core/Helper/Url.php
+++ app/code/core/Mage/Core/Helper/Url.php
@@ -134,6 +134,28 @@ class Mage_Core_Helper_Url extends Mage_Core_Helper_Abstract
     }
...
@@ -130,21 +135,30 @@ class Mage_Customer_Helper_Data extends Mage_Core_Helper_Abstract
      */
...
@@ -170,7 +168,10 @@ class Mage_Customer_Model_Session extends Mage_Core_Model_Session_Abstract
...
@@ -260,18 +262,89 @@ class Mage_Customer_Model_Session extends Mage_Core_Model_Session_Abstract
