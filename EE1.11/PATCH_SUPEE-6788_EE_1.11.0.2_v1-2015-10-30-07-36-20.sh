...
SUPEE-6788 | EE_1.11.0.2 | v1 | 62312034a01a0dbd98cf3e013925e17367f404e6 | Tue Oct 27 16:59:02 2015 +0200 | cd96f1e3d117d16031954501cef5a509a6eda66c..62312034a01a0dbd98cf3e013925e17367f404e6
...
diff --git app/code/core/Mage/Admin/sql/admin_setup/upgrade-1.6.0.0.1.1-1.6.0.0.1.2.php app/code/core/Mage/Admin/sql/admin_setup/upgrade-1.6.0.0.1.1-1.6.0.0.1.2.php
new file mode 100644
index 0000000..7517726
--- /dev/null
+++ app/code/core/Mage/Admin/sql/admin_setup/upgrade-1.6.0.0.1.1-1.6.0.0.1.2.php
@@ -0,0 +1,104 @@
+<?php
+/**
+ * Magento
...
index 506e142..b7898929 100644
--- app/code/core/Mage/Customer/controllers/AccountController.php
+++ app/code/core/Mage/Customer/controllers/AccountController.php
@@ -245,12 +245,17 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
      */
...
@@ -342,7 +347,7 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
@@ -353,9 +358,8 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
...
index 7b39bff..b3046d5 100755
--- app/code/core/Mage/Eav/Model/Resource/Attribute/Collection.php
+++ app/code/core/Mage/Eav/Model/Resource/Attribute/Collection.php
@@ -215,7 +215,9 @@ abstract class Mage_Eav_Model_Resource_Attribute_Collection
...
+        return $this;
     ...
     /**
@@ -227,7 +229,8 @@ abstract class Mage_Eav_Model_Resource_Attribute_Collection
     {
...
@@ -155,7 +170,7 @@ class Mage_Sales_DownloadController extends Mage_Core_Controller_Front_Action
             return;
         }
         try {
