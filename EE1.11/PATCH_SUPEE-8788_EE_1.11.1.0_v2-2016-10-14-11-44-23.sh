...
SUPEE-8788 | CE_1.6.1.0 | v2 | 19b353b96bf304cab76c1a6278315a7c0cb22bca | Fri Oct 14 17:32:46 2016 +0300 | a853722e453c44a6c0f25e29e1860031516191bc
...
index def8da9..f299d28 100644
--- app/code/core/Enterprise/PageCache/Model/Container/Abstract.php
+++ app/code/core/Enterprise/PageCache/Model/Container/Abstract.php
@@ -174,7 +174,7 @@ abstract class Enterprise_PageCache_Model_Container_Abstract
          * Replace all occurrences of session_id with unique marker
          */
...
index 9be2443..9e030e7 100644
--- app/code/core/Enterprise/PageCache/Model/Container/Advanced/Abstract.php
+++ app/code/core/Enterprise/PageCache/Model/Container/Advanced/Abstract.php
@@ -80,10 +80,7 @@ abstract class Enterprise_PageCache_Model_Container_Advanced_Abstract
...
+
      ...
      */
@@ -197,4 +199,24 @@ class Enterprise_PageCache_Model_Cookie extends Mage_Core_Model_Cookie
     {
...
index 8138521..d685f01 100644
--- app/code/core/Enterprise/PageCache/Model/Observer.php
+++ app/code/core/Enterprise/PageCache/Model/Observer.php
@@ -578,4 +578,23 @@ class Enterprise_PageCache_Model_Observer
         }
         return $this;
     }
+
...
index d00735d..2ffd1f0 100644
--- app/code/core/Enterprise/PageCache/Model/Processor.php
+++ app/code/core/Enterprise/PageCache/Model/Processor.php
@@ -391,6 +391,15 @@ class Enterprise_PageCache_Model_Processor
             $isProcessed = false;
         }
...
+
          ...
          */
@@ -473,6 +482,7 @@ class Enterprise_PageCache_Model_Processor
                  * Replace all occurrences of session_id with unique marker
                  */
                 Enterprise_PageCache_Helper_Url::replaceSid($content);
+                Enterprise_PageCache_Helper_Form_Key::replaceFormKey($content);
...
@@ -643,7 +653,13 @@ class Enterprise_PageCache_Model_Processor
          * Define request URI
          */
         if ($uri) {
...
@@ -590,16 +740,14 @@ class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
             $this->renderLayout();
...
@@ -309,7 +326,7 @@ class Mage_Wishlist_IndexController extends Mage_Wishlist_Controller_Abstract
             return $this->_redirect('*/*/');
         }
...
@@ -366,8 +383,7 @@ class Mage_Wishlist_IndexController extends Mage_Wishlist_Controller_Abstract
                 try {
                     $wishlist->save();
...
@@ -385,6 +401,9 @@ class Mage_Wishlist_IndexController extends Mage_Wishlist_Controller_Abstract
      */
...
@@ -399,7 +418,7 @@ class Mage_Wishlist_IndexController extends Mage_Wishlist_Controller_Abstract
...
@@ -420,6 +439,9 @@ class Mage_Wishlist_IndexController extends Mage_Wishlist_Controller_Abstract
      */
...
+        }
         ...
         if (!$wishlist) {
             return $this->_redirect('*/*');
@@ -544,7 +566,7 @@ class Mage_Wishlist_IndexController extends Mage_Wishlist_Controller_Abstract
...
@@ -552,7 +574,7 @@ class Mage_Wishlist_IndexController extends Mage_Wishlist_Controller_Abstract
...
@@ -574,7 +596,7 @@ class Mage_Wishlist_IndexController extends Mage_Wishlist_Controller_Abstract
...
@@ -613,7 +635,7 @@ class Mage_Wishlist_IndexController extends Mage_Wishlist_Controller_Abstract
                     ));
                 }
             }
-        } catch(Exception $e) {
...
+    background:url(images/blank.gif) repeat;
     ...
     color:#d85909;
     font-size:1.1em;
@@ -1260,8 +1260,6 @@ ul.super-product-attributes { padding-left:15px; }
...
index e35e6c4..7e0f127 100644
--- skin/adminhtml/default/enterprise/boxes.css
+++ skin/adminhtml/default/enterprise/boxes.css
@@ -1329,8 +1329,6 @@ ul.super-product-attributes { padding-left:15px; }
 .uploader .file-row-info .file-info-name  { font-weight:bold; }
 .uploader .file-row .progress-text { float:right; font-weight:bold; }
 .uploader .file-row .delete-button { float:right; }
-.uploader .buttons { float:left; }
