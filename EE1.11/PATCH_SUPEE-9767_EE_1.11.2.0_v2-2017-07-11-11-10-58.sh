...
PATCH_SUPEE-9767_EE_1.11.2.0_v2 | EE_1.11.2.0 | v2 | 6566db274beaeb9bcdb56a62e02cc2da532e618c | Thu Jun 22 04:30:03 2017 +0300 | v1.14.3.3..HEAD
...
@@ -416,6 +418,7 @@ class Enterprise_PageCache_Model_Observer
...
@@ -590,11 +593,17 @@ class Enterprise_PageCache_Model_Observer
             return;
         }
...
index 2ffd1f0..0065897 100644
--- app/code/core/Enterprise/PageCache/Model/Processor.php
+++ app/code/core/Enterprise/PageCache/Model/Processor.php
@@ -391,11 +391,9 @@ class Enterprise_PageCache_Model_Processor
             $isProcessed = false;
         }
...
+            new Ajax.Request(
                 ...
                 {
                     method:'post',
@@ -776,14 +754,8 @@ Payment.prototype = {
     },
...
+        new Ajax.Request(
             ...
             {
                 method:'post',
@@ -849,26 +821,22 @@ Review.prototype = {
     },
