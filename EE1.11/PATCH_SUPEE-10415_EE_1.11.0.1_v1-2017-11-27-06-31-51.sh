...
SUPEE-10415-1.11.0.1 | EE_1.11.0.1 | v1 | d66a62d9ef4fedda2ab2f1d6a3fed8a607ecc59a | Tue Nov 7 18:41:23 2017 +0200 | 32e684b421c73e42502fc74c05d6a7e71b628c5d..HEAD

__PATCHFILE_FOLLOWS__
diff --git app/Mage.php app/Mage.php
index ed66f97..629b9d8 100644
--- app/Mage.php
+++ app/Mage.php
...
index 848c698..3da38b5 100644
--- app/code/core/Mage/Api/Helper/Data.php
+++ app/code/core/Mage/Api/Helper/Data.php
@@ -109,6 +109,49 @@ class Mage_Api_Helper_Data extends Mage_Core_Helper_Abstract
     }
...
@@ -199,7 +199,9 @@ class Mage_Api_Model_Server_Adapter_Soap
...
+            $queryParams = Mage::app()->getFrontController()->getRequest()->getQuery();
...
index 504d775..75fc6ee 100644
--- app/code/core/Mage/Customer/Model/Customer.php
+++ app/code/core/Mage/Customer/Model/Customer.php
@@ -45,6 +45,16 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
...
@@ -733,8 +743,19 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
...
index f5ce8b6..7634617 100644
--- app/design/frontend/enterprise/default/template/giftcardaccount/onepage/payment/scripts.phtml
+++ app/design/frontend/enterprise/default/template/giftcardaccount/onepage/payment/scripts.phtml
@@ -30,6 +30,9 @@ if (quoteBaseGrandTotal < 0.0001 && isGiftCardApplied) {
