...
SUPEE-10415-1.11.2.0 | CE_1.6.2.0 | v1 | 0693bfd81c56c49784762206b5d51692f2559788 | Tue Nov 7 18:38:29 2017 +0200 | 0d82a373a529e75bb0343272abdd937a0d5b59c7..HEAD

__PATCHFILE_FOLLOWS__
diff --git app/Mage.php app/Mage.php
index 82f51e8..83cd1c9 100644
--- app/Mage.php
+++ app/Mage.php
...
index db32e83..6e158d0 100644
--- app/code/core/Mage/Api/Helper/Data.php
+++ app/code/core/Mage/Api/Helper/Data.php
@@ -152,6 +152,49 @@ class Mage_Api_Helper_Data extends Mage_Core_Helper_Abstract
     }
...
index c54a905..0cfdfbd 100644
--- app/code/core/Mage/Customer/Model/Customer.php
+++ app/code/core/Mage/Customer/Model/Customer.php
@@ -60,6 +60,16 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
...
+    /**
      ...
      *
      * @var string
@@ -808,8 +818,19 @@ class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
...
index 74a12be..369808e 100644
--- app/design/frontend/enterprise/default/template/giftcardaccount/onepage/payment/scripts.phtml
+++ app/design/frontend/enterprise/default/template/giftcardaccount/onepage/payment/scripts.phtml
@@ -31,6 +31,9 @@ function enablePaymentMethods(free) {
