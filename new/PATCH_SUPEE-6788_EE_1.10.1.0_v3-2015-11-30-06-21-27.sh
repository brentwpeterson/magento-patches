...
SUPEE-6788 | EE_1.10.1.0 | v3 | 55797cbe6592c6f49edeea506f06378fcf949871 | Wed Nov 25 12:36:30 2015 +0200 | 92303bb8f8b9aa1c9082e59550f299aa446e245a..55797cbe6592c6f49edeea506f06378fcf949871
...
@@ -127,9 +127,9 @@ class Mage_Bundle_Model_Mysql4_Option_Collection extends Mage_Core_Model_Mysql4_
...
+
         if ($fileInfo !== null) {
             if (is_array($fileInfo) && $this->_validateFile($fileInfo)) {
                 $value = $fileInfo;
@@ -449,6 +441,11 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
...
@@ -479,7 +476,7 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
     {
...
@@ -509,7 +506,7 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
...
@@ -549,7 +546,7 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
...
@@ -574,7 +571,6 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
...
-                unserialize($option->getValue());
                 ...
                 return null;
@@ -593,7 +589,7 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
...
+            $result = Mage::helper('core/unserializeArray')->unserialize($optionValue);
             ...
             return null;
@@ -609,7 +605,7 @@ class Mage_Catalog_Model_Product_Option_Type_File extends Mage_Catalog_Model_Pro
     {
...
index 2b33109..bde355e 100644
--- app/code/core/Mage/Customer/Model/Entity/Attribute/Collection.php
+++ app/code/core/Mage/Customer/Model/Entity/Attribute/Collection.php
@@ -200,7 +200,8 @@ class Mage_Customer_Model_Entity_Attribute_Collection extends Mage_Eav_Model_Mys
...
@@ -213,7 +214,8 @@ class Mage_Customer_Model_Entity_Attribute_Collection extends Mage_Eav_Model_Mys
     {
