...
SUPEE-10570_v1.13.1.0 | EE_1.13.1.0 | v1 | ec98f0cd571cb4d8c30123d214c7aad96b957bfd | Fri Mar 16 11:27:56 2018 +0200 | ee-1.13.1.0-dev

__PATCHFILE_FOLLOWS__
diff --git app/Mage.php app/Mage.php
index 5e4f298..54b73d6 100644
--- app/Mage.php
+++ app/Mage.php
...
+    /**
      ...
      *
      * @return array
@@ -392,6 +403,15 @@ class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
             return false;
         }
...
@@ -425,6 +445,8 @@ class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
...
@@ -2157,6 +2179,7 @@ class Mage_ImportExport_Model_Import_Entity_Product extends Mage_ImportExport_Mo
