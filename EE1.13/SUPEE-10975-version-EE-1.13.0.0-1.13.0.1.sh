...
SUPEE-10975_EE_v1.13.0.1 | EE_1.13.0.1 | v1 | 359ac9d39a961646c5d64c6662b5a8e05ed0c64e | Fri Nov 16 10:46:51 2018 +0200 | ee-1.13.0.1-dev
...
index 8d2b6f707e7..f9008c6dd1d 100644
--- app/code/core/Enterprise/PageCache/Model/Processor.php
+++ app/code/core/Enterprise/PageCache/Model/Processor.php
@@ -699,13 +699,7 @@ class Enterprise_PageCache_Model_Processor
          * Define request URI
          */
         if ($uri) {
...
index 231daf780e6..cd3ddc8f3e6 100644
...
-            </admin_user_authenticate_after>
             <api_user_authenticated>
                 <observers>
                     <enterprise_pci>
diff --git app/code/core/Enterprise/Wishlist/Block/Customer/Sharing.php app/code/core/Enterprise/Wishlist/Block/Customer/Sharing.php
index 0aa9fa63c2b..5029b86e4cd 100644
--- app/code/core/Enterprise/Wishlist/Block/Customer/Sharing.php
+++ app/code/core/Enterprise/Wishlist/Block/Customer/Sharing.php
...
index cd10ea6b356..8beb2b96df4 100644
...
index 0c69bad4761..7da436e8af3 100644
...
index 71d2bb1634e..da1ebe955ad 100644
...
index 38c89873119..d91ed796bec 100644
...
index 6bd8fb36114..735546c3711 100644
...
index dff30c4864a..241c9e43f04 100644
...
index 3ac43f6e695..f04ff605702 100755
...
index c2a0a0e484b..7dde8024c08 100644
--- app/code/core/Mage/Captcha/Model/Zend.php
+++ app/code/core/Mage/Captcha/Model/Zend.php
@@ -189,6 +189,9 @@ class Mage_Captcha_Model_Zend extends Zend_Captcha_Image implements Mage_Captcha
      */
...
index a3d8e6583bc..42e239a97d6 100755
...
index 58432e52a99..4cd929eac79 100644
...
index 8f9bf80406c..7d12950b01e 100644
...
index b0ec6695da9..3bd304b7742 100644
...
index dbeec27ea0f..e7aa074747e 100644
...
diff --git app/code/core/Mage/Core/sql/core_setup/upgrade-1.6.0.3.1.2-1.6.0.3.1.3.php app/code/core/Mage/Core/sql/core_setup/upgrade-1.6.0.3.1.2-1.6.0.3.1.3.php
new file mode 100644
index 00000000000..ce5e69f9e67
--- /dev/null
+++ app/code/core/Mage/Core/sql/core_setup/upgrade-1.6.0.3.1.2-1.6.0.3.1.3.php
@@ -0,0 +1,41 @@
+<?php
+/**
...
index 030b665862f..7f3267bdc4f 100644
...
index aaedc04dcd4..1a05b243158 100644
...
index 337db5cff9f..c8087fbf576 100644
...
index 5b4dfe48317..12fb09a1cf7 100644
...
index 4eaa53a8fc9..3d730936183 100644
...
index 329cf8e8ceb..a8c8a583a0d 100644
--- app/code/core/Mage/Wishlist/controllers/IndexController.php
+++ app/code/core/Mage/Wishlist/controllers/IndexController.php
@@ -632,6 +632,9 @@ class Mage_Wishlist_IndexController extends Mage_Wishlist_Controller_Abstract
         if (empty($emails)) {
...
index ba26f37938c..1e3496ad88d 100644
...
diff --git app/design/adminhtml/default/default/template/enterprise/cms/page/preview/revision.phtml app/design/adminhtml/default/default/template/enterprise/cms/page/preview/revision.phtml
index 30157baaec3..1cc131fb90c 100644
--- app/design/adminhtml/default/default/template/enterprise/cms/page/preview/revision.phtml
+++ app/design/adminhtml/default/default/template/enterprise/cms/page/preview/revision.phtml
@@ -32,7 +32,7 @@
 <select name="revision_switcher" id="revision_switcher">
     <option value=""><?php echo $this->__('Current Modification') ?></option>
     <?php foreach ($data as $row): ?>
-        <optgroup label="<?php echo $row['label'] ?>">
+        <optgroup label="<?php echo $this->escapeHtml($row['label']) ?>">
         <?php foreach ($row['revisions'] as $item): ?>
             <option value="<?php echo $item->getId() ?>"<?php if($this->getRevisionId() == $item->getId()): ?> selected="selected"<?php endif; ?>>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->__('Revision #%s', $item->getRevisionNumber()) ?></option>
         <?php endforeach; ?>
diff --git app/design/adminhtml/default/default/template/enterprise/customersegment/report/detail/grid/container.phtml app/design/adminhtml/default/default/template/enterprise/customersegment/report/detail/grid/container.phtml
index d237460e2f9..1250fcfeb48 100644
--- app/design/adminhtml/default/default/template/enterprise/customersegment/report/detail/grid/container.phtml
+++ app/design/adminhtml/default/default/template/enterprise/customersegment/report/detail/grid/container.phtml
@@ -62,7 +62,7 @@
...
diff --git app/design/adminhtml/default/default/template/enterprise/giftregistry/customer/form.phtml app/design/adminhtml/default/default/template/enterprise/giftregistry/customer/form.phtml
index 9453f9950e1..df58b7c751f 100644
--- app/design/adminhtml/default/default/template/enterprise/giftregistry/customer/form.phtml
+++ app/design/adminhtml/default/default/template/enterprise/giftregistry/customer/form.phtml
@@ -47,7 +47,7 @@
                     </tr>
                     <tr>
...
+                        <td><?php echo $this->escapeHtml($this->getWebsiteName()); ?></td>
                     </tr>
                     <tr>
                         <td><strong><?php echo $this->__('Owner') ?>:</strong></td>
diff --git app/design/adminhtml/default/default/template/enterprise/staging/log/information/merge.phtml app/design/adminhtml/default/default/template/enterprise/staging/log/information/merge.phtml
index 7b0b18b11a4..f5ea95662ad 100644
--- app/design/adminhtml/default/default/template/enterprise/staging/log/information/merge.phtml
+++ app/design/adminhtml/default/default/template/enterprise/staging/log/information/merge.phtml
@@ -37,8 +37,8 @@
...
diff --git app/design/adminhtml/default/default/template/enterprise/staging/log/information/rollback.phtml app/design/adminhtml/default/default/template/enterprise/staging/log/information/rollback.phtml
index c18ecf569c5..05e1f5ccba0 100644
--- app/design/adminhtml/default/default/template/enterprise/staging/log/information/rollback.phtml
+++ app/design/adminhtml/default/default/template/enterprise/staging/log/information/rollback.phtml
@@ -40,7 +40,7 @@
                     <tr>
                         <td class="label"><label><?php echo Mage::helper('enterprise_staging')->__('Website') ?></label></td>
                         <td>
...
index d18d9c53cd7..9e450cec417 100755
...
index 94b87f7fb93..a2e66b3f017 100644
...
index 79a869178a1..893f4ae8015 100644
...
index 2502d90790e..aaacc8a817a 100644
...
index fad28fbcc43..e71da5e5f11 100755
...
diff --git app/locale/en_US/Enterprise_Wishlist.csv app/locale/en_US/Enterprise_Wishlist.csv
index c2378eeb974..003b9ef2294 100644
--- app/locale/en_US/Enterprise_Wishlist.csv
+++ app/locale/en_US/Enterprise_Wishlist.csv
@@ -77,6 +77,7 @@
 "Please enter at least 2 letters of the first name.","Please enter at least 2 letters of the first name."
 "Please enter at least 2 letters of the last name.","Please enter at least 2 letters of the last name."
 "Please enter at least 2 letters.","Please enter at least 2 letters."
+"Please enter no more than 5 email addresses.","Please enter no more than 5 email addresses."
 ...
 "Please specify correct search options.","Please specify correct search options."
 "Price","Price"
@@ -105,6 +106,7 @@
 "This wishlist is private. Only you can view this wishlist.","This wishlist is private. Only you can view this wishlist."
 "This wishlist is publicly visible.","This wishlist is publicly visible."
 "Unit Price","Unit Price"
+"Up to 5 email addresses, separated by commas","Up to 5 email addresses, separated by commas"
 "Updated at","Updated at"
 "View","View"
 "Wanted Qty","Wanted Qty"
diff --git app/locale/en_US/Mage_Wishlist.csv app/locale/en_US/Mage_Wishlist.csv
index 81bf3b5aca8..f1038136e6b 100644
...
diff --git js/enterprise/adminhtml/staging.js js/enterprise/adminhtml/staging.js
index 3b460f1aecd..bbbff402479 100644
